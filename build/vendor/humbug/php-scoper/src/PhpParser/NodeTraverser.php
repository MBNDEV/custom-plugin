...
use _PhpScoperdd275a4cd119\Humbug\PhpScoper\PhpParser\Node\NameFactory;
use _PhpScoperdd275a4cd119\PhpParser\Node;
use _PhpScoperdd275a4cd119\PhpParser\Node\Stmt;
use _PhpScoperdd275a4cd119\PhpParser\Node\Stmt\Declare_;
use _PhpScoperdd275a4cd119\PhpParser\Node\Stmt\GroupUse;
use _PhpScoperdd275a4cd119\PhpParser\Node\Stmt\InlineHTML;
...
use _PhpScoperdd275a4cd119\PhpParser\NodeVisitor;
