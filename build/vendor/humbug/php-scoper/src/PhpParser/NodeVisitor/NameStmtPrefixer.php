...
use _PhpScoperdd275a4cd119\Humbug\PhpScoper\PhpParser\Node\FullyQualifiedFactory;
...
use _PhpScoperdd275a4cd119\Humbug\PhpScoper\PhpParser\NodeVisitor\Resolver\OriginalNameResolver;
use _PhpScoperdd275a4cd119\Humbug\PhpScoper\PhpParser\NodeVisitor\UseStmt\UseStmtCollection;
use _PhpScoperdd275a4cd119\Humbug\PhpScoper\PhpParser\UseStmtName;
use _PhpScoperdd275a4cd119\Humbug\PhpScoper\Symbol\EnrichedReflector;
use _PhpScoperdd275a4cd119\PhpParser\Node;
use _PhpScoperdd275a4cd119\PhpParser\Node\Attribute;
use _PhpScoperdd275a4cd119\PhpParser\Node\Expr\ArrowFunction;
use _PhpScoperdd275a4cd119\PhpParser\Node\Expr\ClassConstFetch;
use _PhpScoperdd275a4cd119\PhpParser\Node\Expr\Closure;
use _PhpScoperdd275a4cd119\PhpParser\Node\Expr\ConstFetch;
use _PhpScoperdd275a4cd119\PhpParser\Node\Expr\FuncCall;
use _PhpScoperdd275a4cd119\PhpParser\Node\Expr\Instanceof_;
use _PhpScoperdd275a4cd119\PhpParser\Node\Expr\New_;
use _PhpScoperdd275a4cd119\PhpParser\Node\Expr\StaticCall;
use _PhpScoperdd275a4cd119\PhpParser\Node\Expr\StaticPropertyFetch;
use _PhpScoperdd275a4cd119\PhpParser\Node\IntersectionType;
use _PhpScoperdd275a4cd119\PhpParser\Node\Name;
use _PhpScoperdd275a4cd119\PhpParser\Node\Name\FullyQualified;
use _PhpScoperdd275a4cd119\PhpParser\Node\NullableType;
use _PhpScoperdd275a4cd119\PhpParser\Node\Param;
use _PhpScoperdd275a4cd119\PhpParser\Node\Stmt\Catch_;
...
use _PhpScoperdd275a4cd119\PhpParser\Node\Stmt\Property;
use _PhpScoperdd275a4cd119\PhpParser\Node\Stmt\TraitUse;
use _PhpScoperdd275a4cd119\PhpParser\Node\Stmt\TraitUseAdaptation\Alias;
use _PhpScoperdd275a4cd119\PhpParser\Node\Stmt\TraitUseAdaptation\Precedence;
use _PhpScoperdd275a4cd119\PhpParser\Node\Stmt\Use_;
use _PhpScoperdd275a4cd119\PhpParser\Node\UnionType;
