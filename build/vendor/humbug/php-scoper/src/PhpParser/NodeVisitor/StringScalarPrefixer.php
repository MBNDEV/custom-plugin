...
use _PhpScoperdd275a4cd119\Humbug\PhpScoper\PhpParser\UnexpectedParsingScenario;
...
use _PhpScoperdd275a4cd119\PhpParser\Node\ArrayItem;
use _PhpScoperdd275a4cd119\PhpParser\Node\Const_;
use _PhpScoperdd275a4cd119\PhpParser\Node\Expr\Array_;
use _PhpScoperdd275a4cd119\PhpParser\Node\Expr\Assign;
...
use _PhpScoperdd275a4cd119\PhpParser\Node\Stmt\PropertyProperty;
use _PhpScoperdd275a4cd119\PhpParser\Node\Stmt\Return_;
