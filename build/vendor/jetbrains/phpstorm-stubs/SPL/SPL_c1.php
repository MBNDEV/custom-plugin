 ...
 * @link https://php.net/manual/en/class.splfileinfo.php
 */
\class_alias('_PhpScoperdd275a4cd119\SplFileInfo', 'SplFileInfo', \false);
/**
 ...
 * @link https://php.net/manual/en/class.directoryiterator.php
 */
\class_alias('_PhpScoperdd275a4cd119\DirectoryIterator', 'DirectoryIterator', \false);
/**
 ...
 * @link https://php.net/manual/en/class.filesystemiterator.php
 */
\class_alias('_PhpScoperdd275a4cd119\FilesystemIterator', 'FilesystemIterator', \false);
/**
 ...
 * @link https://php.net/manual/en/class.recursivedirectoryiterator.php
 */
\class_alias('_PhpScoperdd275a4cd119\RecursiveDirectoryIterator', 'RecursiveDirectoryIterator', \false);
/**
 ...
 * @link https://php.net/manual/en/class.globiterator.php
 */
\class_alias('_PhpScoperdd275a4cd119\GlobIterator', 'GlobIterator', \false);
/**
 ...
 * @link https://php.net/manual/en/class.splfileobject.php
 */
\class_alias('_PhpScoperdd275a4cd119\SplFileObject', 'SplFileObject', \false);
/**
 ...
 * @link https://php.net/manual/en/class.spltempfileobject.php
 */
\class_alias('_PhpScoperdd275a4cd119\SplTempFileObject', 'SplTempFileObject', \false);
/**
 * @template TValue
 ...
 * @template-implements ArrayAccess<int, TValue>
 */
\class_alias('_PhpScoperdd275a4cd119\SplDoublyLinkedList', 'SplDoublyLinkedList', \false);
/**
 * @template TValue
 ...
 * @link https://php.net/manual/en/class.splqueue.php
 */
\class_alias('_PhpScoperdd275a4cd119\SplQueue', 'SplQueue', \false);
/**
 * @template TValue
 ...
 * @template-extends SplDoublyLinkedList<TValue>
 */
\class_alias('_PhpScoperdd275a4cd119\SplStack', 'SplStack', \false);
/**
 * @template TValue
 ...
 * @template-implements Iterator<int, TValue>
 */
\class_alias('_PhpScoperdd275a4cd119\SplHeap', 'SplHeap', \false);
/**
 * @template TValue
 ...
 * @template-extends SplHeap<TValue>
 */
\class_alias('_PhpScoperdd275a4cd119\SplMinHeap', 'SplMinHeap', \false);
/**
 * @template TValue
 ...
 * @template-extends SplHeap<TValue>
 */
\class_alias('_PhpScoperdd275a4cd119\SplMaxHeap', 'SplMaxHeap', \false);
/**
 * @template TPriority
 * @template TValue
 ...
 * @template-implements Iterator<int, TValue>
 */
\class_alias('_PhpScoperdd275a4cd119\SplPriorityQueue', 'SplPriorityQueue', \false);
/**
 * @template TValue
 ...
 * @template-implements IteratorAggregate<int, TValue>
 */
\class_alias('_PhpScoperdd275a4cd119\SplFixedArray', 'SplFixedArray', \false);
/**
 ...
 * @link https://php.net/manual/en/class.splobserver.php
 */
\class_alias('_PhpScoperdd275a4cd119\SplObserver', 'SplObserver', \false);
/**
 ...
 * @link https://php.net/manual/en/class.splsubject.php
 */
\class_alias('_PhpScoperdd275a4cd119\SplSubject', 'SplSubject', \false);
/**
 ...
 * @template-implements ArrayAccess<TObject, TValue>
 */
\class_alias('_PhpScoperdd275a4cd119\SplObjectStorage', 'SplObjectStorage', \false);
/**
 ...
 * @link https://php.net/manual/en/class.multipleiterator.php
 */
\class_alias('_PhpScoperdd275a4cd119\MultipleIterator', 'MultipleIterator', \false);
