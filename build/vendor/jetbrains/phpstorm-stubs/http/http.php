...
\class_alias('_PhpScoperdd275a4cd119\HttpException', 'HttpException', \false);
class HttpRuntimeException extends \HttpException
{
}
\class_alias('_PhpScoperdd275a4cd119\HttpRuntimeException', 'HttpRuntimeException', \false);
class HttpInvalidParamException extends \HttpException
{
}
\class_alias('_PhpScoperdd275a4cd119\HttpInvalidParamException', 'HttpInvalidParamException', \false);
class HttpHeaderException extends \HttpException
{
}
\class_alias('_PhpScoperdd275a4cd119\HttpHeaderException', 'HttpHeaderException', \false);
class HttpMalformedHeadersException extends \HttpException
{
}
\class_alias('_PhpScoperdd275a4cd119\HttpMalformedHeadersException', 'HttpMalformedHeadersException', \false);
class HttpRequestMethodException extends \HttpException
{
}
\class_alias('_PhpScoperdd275a4cd119\HttpRequestMethodException', 'HttpRequestMethodException', \false);
class HttpMessageTypeException extends \HttpException
{
}
\class_alias('_PhpScoperdd275a4cd119\HttpMessageTypeException', 'HttpMessageTypeException', \false);
class HttpEncodingException extends \HttpException
{
}
\class_alias('_PhpScoperdd275a4cd119\HttpEncodingException', 'HttpEncodingException', \false);
class HttpRequestException extends \HttpException
{
}
\class_alias('_PhpScoperdd275a4cd119\HttpRequestException', 'HttpRequestException', \false);
class HttpRequestPoolException extends \HttpException
{
}
\class_alias('_PhpScoperdd275a4cd119\HttpRequestPoolException', 'HttpRequestPoolException', \false);
class HttpSocketException extends \HttpException
{
}
\class_alias('_PhpScoperdd275a4cd119\HttpSocketException', 'HttpSocketException', \false);
class HttpResponseException extends \HttpException
{
}
\class_alias('_PhpScoperdd275a4cd119\HttpResponseException', 'HttpResponseException', \false);
class HttpUrlException extends \HttpException
{
}
\class_alias('_PhpScoperdd275a4cd119\HttpUrlException', 'HttpUrlException', \false);
class HttpQueryStringException extends \HttpException
{
}
\class_alias('_PhpScoperdd275a4cd119\HttpQueryStringException', 'HttpQueryStringException', \false);
/**
 ...
 * @link https://php.net/manual/en/class.httpdeflatestream.php
 */
\class_alias('_PhpScoperdd275a4cd119\HttpDeflateStream', 'HttpDeflateStream', \false);
/**
 ...
 * @link https://php.net/manual/en/class.httpinflatestream.php
 */
\class_alias('_PhpScoperdd275a4cd119\HttpInflateStream', 'HttpInflateStream', \false);
/**
 ...
 * @link https://php.net/manual/en/class.httpmessage.php
 */
\class_alias('_PhpScoperdd275a4cd119\HttpMessage', 'HttpMessage', \false);
/**
 ...
 * @link https://php.net/manual/en/class.httpquerystring.php
 */
\class_alias('_PhpScoperdd275a4cd119\HttpQueryString', 'HttpQueryString', \false);
/**
 ...
 * @link https://php.net/manual/en/class.httprequest.php
 */
\class_alias('_PhpScoperdd275a4cd119\HttpRequest', 'HttpRequest', \false);
...
\class_alias('_PhpScoperdd275a4cd119\HttpRequestDataShare', 'HttpRequestDataShare', \false);
/**
 ...
 * @link https://php.net/manual/en/class.httprequestpool.php
 */
\class_alias('_PhpScoperdd275a4cd119\HttpRequestPool', 'HttpRequestPool', \false);
/**
 ...
 * @link https://php.net/manual/en/class.httpresponse.php
 */
\class_alias('_PhpScoperdd275a4cd119\HttpResponse', 'HttpResponse', \false);
class HttpUtil
{
    /**
...
\class_alias('_PhpScoperdd275a4cd119\HttpUtil', 'HttpUtil', \false);
/**
