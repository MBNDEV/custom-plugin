...
use _PhpScoperdd275a4cd119\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware as PhpVersionAware;
use _PhpScoperdd275a4cd119\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable as Available;
use LDAP\Result;
/**
...
function ldap_exop_passwd(
    #[PhpVersionAware(['8.1' => '_PhpScoperdd275a4cd119\LDAP\Connection'], default: 'resource')]
    $ldap,
...
function ldap_parse_exop(
    #[PhpVersionAware(['8.1' => '_PhpScoperdd275a4cd119\LDAP\Connection'], default: 'resource')]
    $ldap,
    #[PhpVersionAware(['8.1' => '_PhpScoperdd275a4cd119\LDAP\Result'], default: 'resource')]
    $result,
...
function ldap_next_entry(
    #[PhpVersionAware(['8.1' => '_PhpScoperdd275a4cd119\LDAP\Connection'], default: 'resource')]
    $ldap,
    #[PhpVersionAware(['8.1' => '_PhpScoperdd275a4cd119\LDAP\ResultEntry'], default: 'resource')]
    $entry
)
{
}
