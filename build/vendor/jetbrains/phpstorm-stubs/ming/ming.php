...
// Start of ming v.
\class_alias('_PhpScoperdd275a4cd119\SWFShape', 'SWFShape', \false);
class SWFFill
{
    public function __construct()
    {
...
\class_alias('_PhpScoperdd275a4cd119\SWFFill', 'SWFFill', \false);
class SWFGradient
{
    public function __construct()
    {
...
\class_alias('_PhpScoperdd275a4cd119\SWFGradient', 'SWFGradient', \false);
class SWFBitmap
{
    public function __construct()
    {
...
\class_alias('_PhpScoperdd275a4cd119\SWFBitmap', 'SWFBitmap', \false);
class SWFText
{
    public function __construct()
    {
...
\class_alias('_PhpScoperdd275a4cd119\SWFText', 'SWFText', \false);
class SWFTextField
{
    public function __construct()
    {
...
\class_alias('_PhpScoperdd275a4cd119\SWFTextField', 'SWFTextField', \false);
class SWFFont
{
    public function __construct()
    {
...
\class_alias('_PhpScoperdd275a4cd119\SWFFont', 'SWFFont', \false);
...
\class_alias('_PhpScoperdd275a4cd119\SWFDisplayItem', 'SWFDisplayItem', \false);
class SWFMovie
{
    public function __construct()
    {
...
\class_alias('_PhpScoperdd275a4cd119\SWFMovie', 'SWFMovie', \false);
class SWFButton
{
    public function __construct()
    {
...
\class_alias('_PhpScoperdd275a4cd119\SWFButton', 'SWFButton', \false);
class SWFAction
{
    public function __construct()
    {
...
\class_alias('_PhpScoperdd275a4cd119\SWFAction', 'SWFAction', \false);
class SWFMorph
{
    public function __construct()
    {
...
\class_alias('_PhpScoperdd275a4cd119\SWFMorph', 'SWFMorph', \false);
class SWFSprite
{
    public function __construct()
    {
...
\class_alias('_PhpScoperdd275a4cd119\SWFSprite', 'SWFSprite', \false);
class SWFSound
{
    public function __construct()
    {
...
\class_alias('_PhpScoperdd275a4cd119\SWFSound', 'SWFSound', \false);
class SWFFontChar
{
    public function addChars()
    {
...
\class_alias('_PhpScoperdd275a4cd119\SWFFontChar', 'SWFFontChar', \false);
...
\class_alias('_PhpScoperdd275a4cd119\SWFSoundInstance', 'SWFSoundInstance', \false);
...
\class_alias('_PhpScoperdd275a4cd119\SWFVideoStream', 'SWFVideoStream', \false);
/**
 * Set cubic threshold
