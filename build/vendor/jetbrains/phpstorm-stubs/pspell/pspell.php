...
function pspell_new_config(
    #[LanguageLevelTypeAware(['8.1' => '_PhpScoperdd275a4cd119\PSpell\Config'], default: 'int')]
    $config
)
{
}
...
function pspell_check(
    #[LanguageLevelTypeAware(['8.1' => '_PhpScoperdd275a4cd119\PSpell\Dictionary'], default: 'int')]
    $dictionary,
    string $word
): bool
{
