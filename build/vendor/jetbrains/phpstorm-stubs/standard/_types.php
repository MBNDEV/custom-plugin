 ...
 * @template-implements Iterator<TKey, TYield>
 */
\class_alias('_PhpScoperdd275a4cd119\Generator', 'Generator', \false);
class ClosedGeneratorException extends \Exception
{
}
\class_alias('_PhpScoperdd275a4cd119\ClosedGeneratorException', 'ClosedGeneratorException', \false);
namespace _PhpScoperdd275a4cd119\___PHPSTORM_HELPERS;
