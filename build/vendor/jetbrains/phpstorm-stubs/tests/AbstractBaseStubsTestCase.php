...
use _PhpScoperdd275a4cd119\PhpParser\Node\Expr\BinaryOp\BitwiseOr;
use _PhpScoperdd275a4cd119\PhpParser\Node\Expr\ClassConstFetch;
use _PhpScoperdd275a4cd119\PhpParser\Node\Expr\ConstFetch;
use _PhpScoperdd275a4cd119\PhpParser\Node\Expr\UnaryMinus;
use _PhpScoperdd275a4cd119\PhpParser\Node\Scalar\DNumber;
use _PhpScoperdd275a4cd119\PhpParser\Node\Scalar\LNumber;
use _PhpScoperdd275a4cd119\PhpParser\Node\Scalar\String_;
use _PhpScoperdd275a4cd119\PHPUnit\Framework\Exception;
