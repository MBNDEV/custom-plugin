...
\class_alias('_PhpScoperdd275a4cd119\UV', 'UV', \false);
abstract class UVStream extends \UV
{
}
\class_alias('_PhpScoperdd275a4cd119\UVStream', 'UVStream', \false);
class UVTcp extends \UVStream
{
}
\class_alias('_PhpScoperdd275a4cd119\UVTcp', 'UVTcp', \false);
class UVUdp extends \UV
{
}
\class_alias('_PhpScoperdd275a4cd119\UVUdp', 'UVUdp', \false);
class UVPipe extends \UVStream
{
}
\class_alias('_PhpScoperdd275a4cd119\UVPipe', 'UVPipe', \false);
class UVIdle extends \UV
{
}
\class_alias('_PhpScoperdd275a4cd119\UVIdle', 'UVIdle', \false);
class UVTimer extends \UV
{
}
\class_alias('_PhpScoperdd275a4cd119\UVTimer', 'UVTimer', \false);
class UVAsync extends \UV
{
}
\class_alias('_PhpScoperdd275a4cd119\UVAsync', 'UVAsync', \false);
class UVAddrinfo extends \UV
{
}
\class_alias('_PhpScoperdd275a4cd119\UVAddrinfo', 'UVAddrinfo', \false);
class UVProcess extends \UV
{
}
\class_alias('_PhpScoperdd275a4cd119\UVProcess', 'UVProcess', \false);
class UVPrepare extends \UV
{
}
\class_alias('_PhpScoperdd275a4cd119\UVPrepare', 'UVPrepare', \false);
class UVCheck extends \UV
{
}
\class_alias('_PhpScoperdd275a4cd119\UVCheck', 'UVCheck', \false);
class UVWork extends \UV
{
}
\class_alias('_PhpScoperdd275a4cd119\UVWork', 'UVWork', \false);
class UVFs extends \UV
{
}
\class_alias('_PhpScoperdd275a4cd119\UVFs', 'UVFs', \false);
class UVFsEvent extends \UV
{
}
\class_alias('_PhpScoperdd275a4cd119\UVFsEvent', 'UVFsEvent', \false);
class UVTty extends \UVStream
{
}
\class_alias('_PhpScoperdd275a4cd119\UVTty', 'UVTty', \false);
class UVFsPoll extends \UV
{
}
\class_alias('_PhpScoperdd275a4cd119\UVFsPoll', 'UVFsPoll', \false);
class UVPoll extends \UV
{
}
\class_alias('_PhpScoperdd275a4cd119\UVPoll', 'UVPoll', \false);
class UVSignal extends \UV
{
}
\class_alias('_PhpScoperdd275a4cd119\UVSignal', 'UVSignal', \false);
class UVLoop
{
}
\class_alias('_PhpScoperdd275a4cd119\UVLoop', 'UVLoop', \false);
abstract class UVSockAddr
{
}
\class_alias('_PhpScoperdd275a4cd119\UVSockAddr', 'UVSockAddr', \false);
class UVSockAddrIPv4 extends \UVSockAddr
{
}
\class_alias('_PhpScoperdd275a4cd119\UVSockAddrIPv4', 'UVSockAddrIPv4', \false);
class UVSockAddrIPv6 extends \UVSockAddr
{
}
\class_alias('_PhpScoperdd275a4cd119\UVSockAddrIPv6', 'UVSockAddrIPv6', \false);
class UVLock
{
}
\class_alias('_PhpScoperdd275a4cd119\UVLock', 'UVLock', \false);
class UVStdio
{
}
\class_alias('_PhpScoperdd275a4cd119\UVStdio', 'UVStdio', \false);
