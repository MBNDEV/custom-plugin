 ...
 * @link https://secure.php.net/manual/en/class.zmq.php
 */
\class_alias('_PhpScoperdd275a4cd119\ZMQ', 'ZMQ', \false);
/**
 * Class ZMQContext
 ...
 * @link https://secure.php.net/manual/en/class.zmqcontext.php
 */
\class_alias('_PhpScoperdd275a4cd119\ZMQContext', 'ZMQContext', \false);
/**
 * Class ZMQSocket
 ...
 * @link https://secure.php.net/manual/en/class.zmqsocket.php
 */
\class_alias('_PhpScoperdd275a4cd119\ZMQSocket', 'ZMQSocket', \false);
/**
 * Class ZMQPoll
 ...
 * @link https://secure.php.net/manual/en/class.zmqpoll.php
 */
\class_alias('_PhpScoperdd275a4cd119\ZMQPoll', 'ZMQPoll', \false);
/**
 * Class ZMQDevice
 ...
 * @link https://secure.php.net/manual/en/class.zmqdevice.php
 */
\class_alias('_PhpScoperdd275a4cd119\ZMQDevice', 'ZMQDevice', \false);
class ZMQException extends \Exception
{
}
\class_alias('_PhpScoperdd275a4cd119\ZMQException', 'ZMQException', \false);
class ZMQContextException extends \ZMQException
{
}
\class_alias('_PhpScoperdd275a4cd119\ZMQContextException', 'ZMQContextException', \false);
class ZMQSocketException extends \ZMQException
{
}
\class_alias('_PhpScoperdd275a4cd119\ZMQSocketException', 'ZMQSocketException', \false);
class ZMQPollException extends \ZMQException
{
}
\class_alias('_PhpScoperdd275a4cd119\ZMQPollException', 'ZMQPollException', \false);
class ZMQDeviceException extends \ZMQException
{
}
\class_alias('_PhpScoperdd275a4cd119\ZMQDeviceException', 'ZMQDeviceException', \false);
