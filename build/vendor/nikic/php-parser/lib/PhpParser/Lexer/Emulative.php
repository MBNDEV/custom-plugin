...
namespace _PhpScoperdd275a4cd119\PhpParser\Lexer;
...
use _PhpScoperdd275a4cd119\PhpParser\Lexer\TokenEmulator\AsymmetricVisibilityTokenEmulator;
use _PhpScoperdd275a4cd119\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use _PhpScoperdd275a4cd119\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use _PhpScoperdd275a4cd119\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use _PhpScoperdd275a4cd119\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use _PhpScoperdd275a4cd119\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use _PhpScoperdd275a4cd119\PhpParser\Lexer\TokenEmulator\PipeOperatorEmulator;
use _PhpScoperdd275a4cd119\PhpParser\Lexer\TokenEmulator\PropertyTokenEmulator;
use _PhpScoperdd275a4cd119\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use _PhpScoperdd275a4cd119\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use _PhpScoperdd275a4cd119\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use _PhpScoperdd275a4cd119\PhpParser\Lexer\TokenEmulator\TokenEmulator;
use _PhpScoperdd275a4cd119\PhpParser\Lexer\TokenEmulator\VoidCastEmulator;
