...
final class NoEchoSprintfSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        if ($next === \false || $tokens[$next]['code'] !== \T_STRING && $tokens[$next]['code'] !== \T_NAME_FULLY_QUALIFIED) {
        ...
        if ($openParens === \false || $tokens[$openParens]['code'] !== \T_OPEN_PARENTHESIS || isset($tokens[$openParens]['parenthesis_closer']) === \false) {
