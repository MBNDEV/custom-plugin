 ...
 */
namespace _PhpScoperdd275a4cd119\PHPCSExtra\Universal\Sniffs\OOStructures;
...
final class AlphabeticExtendsImplementsSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        $data = [$tokens[$stackPtr]['content'], $tokens[$keywordPtr]['content'], \implode(', ', $sorted), \implode(', ', $names)];
        if ($fixable === \false) {
            $code .= 'WithComments';
