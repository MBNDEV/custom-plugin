...
final class RequireExitDieParenthesesSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        $fix = $phpcsFile->addFixableError('Parentheses required when calling %s, even if no argument is given.', $stackPtr, 'Missing', [\strtolower(\ltrim($tokens[$stackPtr]['content'], '\\'))]);
        if ($fix === \true) {
