 ...
 */
namespace _PhpScoperdd275a4cd119\PHPCSExtra\Universal\Sniffs\WhiteSpace;
...
use _PhpScoperdd275a4cd119\PHPCSUtils\Fixers\SpacesFixer;
...
final class CommaSpacingSniff implements Sniff
{
    ...
    protected function processSpacingBefore(File $phpcsFile, $stackPtr)
    {
        ...
        if (isset(Tokens::$blockOpeners[$tokens[$prevNonWhitespace]['code']]) === \true || $tokens[$prevNonWhitespace]['code'] === \T_OPEN_SHORT_ARRAY || $tokens[$prevNonWhitespace]['code'] === \T_OPEN_USE_GROUP || $tokens[$prevNonWhitespace]['code'] === \T_ATTRIBUTE) {
    ...
    protected function processSpacingAfter(File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[$nextNonWhitespace]['code'] === \T_CLOSE_CURLY_BRACKET || $tokens[$nextNonWhitespace]['code'] === \T_CLOSE_SQUARE_BRACKET || $tokens[$nextNonWhitespace]['code'] === \T_CLOSE_PARENTHESIS || $tokens[$nextNonWhitespace]['code'] === \T_CLOSE_SHORT_ARRAY || $tokens[$nextNonWhitespace]['code'] === \T_CLOSE_USE_GROUP || $tokens[$nextNonWhitespace]['code'] === \T_ATTRIBUTE_END) {
