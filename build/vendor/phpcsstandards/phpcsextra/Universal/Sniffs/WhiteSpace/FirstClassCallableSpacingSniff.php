...
final class FirstClassCallableSpacingSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        SpacesFixer::checkAndFix($phpcsFile, $previousNonEmpty, $stackPtr, $spacing, 'Incorrect spacing between first class callable open parentheses and ellipsis. Expected: %s, found: %s.', 'SpacingBefore', 'error', 0, 'First class callables: space before ellipsis');
        // Check spacing after the ellipsis.
        SpacesFixer::checkAndFix($phpcsFile, $stackPtr, $nextNonEmpty, $spacing, 'Incorrect spacing between first class callable ellipsis and close parentheses. Expected: %s, found: %s.', 'SpacingAfter', 'error', 0, 'First class callables: space after ellipsis');
    }
}
