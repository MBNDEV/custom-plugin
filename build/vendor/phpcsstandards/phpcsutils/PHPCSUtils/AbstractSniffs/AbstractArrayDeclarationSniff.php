 ...
 */
namespace _PhpScoperdd275a4cd119\PHPCSUtils\AbstractSniffs;
...
use _PhpScoperdd275a4cd119\PHPCSUtils\Exceptions\LogicException;
...
use _PhpScoperdd275a4cd119\PHPCSUtils\Utils\Numbers;
...
abstract class AbstractArrayDeclarationSniff implements Sniff
{
     ...
     */
    private $acceptedTokens = [\T_NULL => \T_NULL, \T_TRUE => \T_TRUE, \T_FALSE => \T_FALSE, \T_LNUMBER => \T_LNUMBER, \T_DNUMBER => \T_DNUMBER, \T_CONSTANT_ENCAPSED_STRING => \T_CONSTANT_ENCAPSED_STRING, \T_STRING_CONCAT => \T_STRING_CONCAT, \T_BOOLEAN_NOT => \T_BOOLEAN_NOT];
    /**
     * Set up this class.
     *
     * @since 1.0.0
    ...
    public function getActualArrayKey(File $phpcsFile, $startPtr, $endPtr)
    {
        ...
        for ($i = $firstNonEmpty; $i <= $lastNonEmpty; $i++) {
            ...
            if ($this->tokens[$i]['code'] === \T_NS_SEPARATOR) {
                ...
                if ($nextNonEmpty !== \false && ($this->tokens[$nextNonEmpty]['code'] === \T_TRUE || $this->tokens[$nextNonEmpty]['code'] === \T_FALSE || $this->tokens[$nextNonEmpty]['code'] === \T_NULL)) {
                    $content .= $this->tokens[$nextNonEmpty]['content'];
                    $i = $nextNonEmpty;
                    continue;
                }
            }
            if (isset($this->acceptedTokens[$this->tokens[$i]['code']]) === \false || \T_UNSET_CAST === $this->tokens[$i]['code']) {
