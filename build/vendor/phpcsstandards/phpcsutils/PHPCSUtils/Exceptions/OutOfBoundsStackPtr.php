 ...
 */
namespace _PhpScoperdd275a4cd119\PHPCSUtils\Exceptions;
...
final class OutOfBoundsStackPtr extends RuntimeException
{
    ...
    public static function create($position, $name, $received)
    {
        ...
        return new self(\sprintf('%s::%s(): Argument #%d (%s) must be a stack pointer which exists in the $phpcsFile object, %s given.', $stack[1]['class'], $stack[1]['function'], $position, $name, \is_scalar($received) ? \var_export($received, \true) : \gettype($received)));
    }
}
