 ...
 */
namespace _PhpScoperdd275a4cd119\PHPCSUtils\TestUtils;

use _PhpScoperdd275a4cd119\PHP_CodeSniffer\Config;
...
use _PhpScoperdd275a4cd119\PHP_CodeSniffer\Files\LocalFile;
use _PhpScoperdd275a4cd119\PHP_CodeSniffer\Ruleset;
use _PhpScoperdd275a4cd119\PHPCSUtils\BackCompat\Helper;
use _PhpScoperdd275a4cd119\PHPCSUtils\Exceptions\TestFileNotFound;
use _PhpScoperdd275a4cd119\PHPCSUtils\Exceptions\TestMarkerNotFound;
use _PhpScoperdd275a4cd119\PHPCSUtils\Exceptions\TestTargetNotFound;
use _PhpScoperdd275a4cd119\PHPCSUtils\TestUtils\ConfigDouble;
use _PhpScoperdd275a4cd119\PHPCSUtils\TestUtils\RulesetDouble;
use _PhpScoperdd275a4cd119\PHPUnit\Framework\Attributes\AfterClass;
use _PhpScoperdd275a4cd119\PHPUnit\Framework\Attributes\Before;
use _PhpScoperdd275a4cd119\PHPUnit\Framework\Attributes\BeforeClass;
...
abstract class UtilityMethodTestCase extends TestCase
{
    ...
    {
        $property = new ReflectionProperty('_PhpScoperdd275a4cd119\PHP_CodeSniffer\Config', $name);
    ...
    {
        $exception = '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Exceptions\RuntimeException';
        if ($type === 'tokenizer') {
            $exception = '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Exceptions\TokenizerException';
        }
