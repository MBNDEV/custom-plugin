 ...
 */
namespace _PhpScoperdd275a4cd119\PHPCSUtils\Tokens;

use _PhpScoperdd275a4cd119\PHPCSUtils\Exceptions\InvalidTokenArray;
/**
...
final class Collections
{
     ...
     * @var array<int|string, int|string>
     */
    private static $ooPropertyScopes = [\T_CLASS => \T_CLASS, \T_ANON_CLASS => \T_ANON_CLASS, \T_INTERFACE => \T_INTERFACE, \T_TRAIT => \T_TRAIT];
    /**
     ...
     * @var array<int|string, int|string>
     */
    private static $parameterTypeTokens = [\T_CALLABLE => \T_CALLABLE, \T_SELF => \T_SELF, \T_PARENT => \T_PARENT, \T_FALSE => \T_FALSE, \T_TRUE => \T_TRUE, \T_NULL => \T_NULL, \T_TYPE_UNION => \T_TYPE_UNION, \T_TYPE_INTERSECTION => \T_TYPE_INTERSECTION, \T_TYPE_OPEN_PARENTHESIS => \T_TYPE_OPEN_PARENTHESIS, \T_TYPE_CLOSE_PARENTHESIS => \T_TYPE_CLOSE_PARENTHESIS];
    /**
     ...
     * @var array<int|string, int|string>
     */
    private static $propertyModifierKeywords = [\T_PUBLIC => \T_PUBLIC, \T_PUBLIC_SET => \T_PUBLIC_SET, \T_PROTECTED => \T_PROTECTED, \T_PROTECTED_SET => \T_PROTECTED_SET, \T_PRIVATE => \T_PRIVATE, \T_PRIVATE_SET => \T_PRIVATE_SET, \T_STATIC => \T_STATIC, \T_VAR => \T_VAR, \T_READONLY => \T_READONLY, \T_FINAL => \T_FINAL, \T_ABSTRACT => \T_ABSTRACT];
    /**
     ...
     * @var array<int|string, int|string>
     */
    private static $returnTypeTokens = [\T_CALLABLE => \T_CALLABLE, \T_FALSE => \T_FALSE, \T_TRUE => \T_TRUE, \T_NULL => \T_NULL, \T_TYPE_UNION => \T_TYPE_UNION, \T_TYPE_INTERSECTION => \T_TYPE_INTERSECTION, \T_TYPE_OPEN_PARENTHESIS => \T_TYPE_OPEN_PARENTHESIS, \T_TYPE_CLOSE_PARENTHESIS => \T_TYPE_CLOSE_PARENTHESIS];
    /**
     ...
     * @var array<int|string, int|string>
     */
    private static $ternaryOperators = [\T_INLINE_THEN => \T_INLINE_THEN, \T_INLINE_ELSE => \T_INLINE_ELSE];
    /**
