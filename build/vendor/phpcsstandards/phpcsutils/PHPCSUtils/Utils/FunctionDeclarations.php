...
use _PhpScoperdd275a4cd119\PHPCSUtils\Utils\UseStatements;
/**
    ...
    public static function getProperties(File $phpcsFile, $stackPtr)
    {
        ...
        if (isset($parenthesisCloser) === \true) {
            ...
            for ($i = $parenthesisCloser; $i < $phpcsFile->numTokens; $i++) {
                ...
                if ($scopeOpener === null && ($tokens[$i]['code'] === \T_SEMICOLON || $tokens[$i]['code'] === \T_OPEN_CURLY_BRACKET)) {
                    // End of abstract/interface function definition.
                    break;
                }
                if ($tokens[$i]['code'] === \T_USE) {
                    // Skip over closure use statements.
                    for ($j = $i + 1; $j < $phpcsFile->numTokens && isset(Tokens::$emptyTokens[$tokens[$j]['code']]) === \true; $j++) {
                    }
