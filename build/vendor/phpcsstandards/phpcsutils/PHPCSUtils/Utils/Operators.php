...
final class Operators
{
    ...
    public static function isUnaryPlusMinus(File $phpcsFile, $stackPtr)
    {
         ...
         */
        if (isset(Tokens::$operators[$tokens[$prev]['code']]) === \true || isset(Tokens::$comparisonTokens[$tokens[$prev]['code']]) === \true || isset(Tokens::$booleanOperators[$tokens[$prev]['code']]) === \true || isset(Tokens::$assignmentTokens[$tokens[$prev]['code']]) === \true || isset(Tokens::$castTokens[$tokens[$prev]['code']]) === \true || isset(Collections::ternaryOperators()[$tokens[$prev]['code']]) === \true || isset(self::$extraUnaryIndicators[$tokens[$prev]['code']]) === \true) {
            return \true;
        }
        return \false;
    }
