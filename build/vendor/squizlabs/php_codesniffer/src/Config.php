 ...
 */
namespace _PhpScoperdd275a4cd119\PHP_CodeSniffer;

use Exception;
use Phar;
use _PhpScoperdd275a4cd119\PHP_CodeSniffer\Exceptions\DeepExitException;
...
use _PhpScoperdd275a4cd119\PHP_CodeSniffer\Util\Help;
use _PhpScoperdd275a4cd119\PHP_CodeSniffer\Util\Standards;
/**
 * Stores the configuration used to run PHPCS and PHPCBF.
 *
...
class Config
{
    ...
    public function __set($name, $value)
    {
        ...
        switch ($name) {
            case 'reportWidth':
                ...
                if (is_int($value) === \true) {
                    $value = abs($value);
                } else if (is_string($value) === \true && preg_match('`^\d+$`', $value) === 1) {
                    $value = (int) $value;
                } else {
    ...
    public function processLongArgument($arg, $pos)
    {
        switch ($arg) {
            ...
            default:
                ...
                } else if (defined('PHP_CODESNIFFER_IN_TESTS') === \false && substr($arg, 0, 6) === 'cache=') {
                ...
                } else if (substr($arg, 0, 10) === 'generator=' && PHP_CODESNIFFER_CBF === \false) {
    ...
    public static function setConfigData($key, $value, $temp = \false)
    {
        ...
        if ($temp === \false) {
            $path = '';
            if (is_callable('_PhpScoperdd275a4cd119\Phar::running') === \true) {
