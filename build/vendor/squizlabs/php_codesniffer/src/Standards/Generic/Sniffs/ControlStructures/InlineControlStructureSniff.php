 ...
 */
namespace _PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\Generic\Sniffs\ControlStructures;
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        if ($next !== $end) {
            ...
            if ($next !== \false && ($tokens[$next]['code'] === \T_ELSE || $tokens[$next]['code'] === \T_ELSEIF)) {
                ...
                } else if ($tokens[$first]['code'] === \T_INLINE_HTML || $tokens[$first]['code'] === \T_OPEN_TAG) {
                    $addedContent = '';
                }
                $addedContent .= $indent . '}';
