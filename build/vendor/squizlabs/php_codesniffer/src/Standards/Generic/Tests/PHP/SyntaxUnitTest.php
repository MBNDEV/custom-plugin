 ...
 */
namespace _PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\Generic\Tests\PHP;

use _PhpScoperdd275a4cd119\PHP_CodeSniffer\Files\DummyFile;
use _PhpScoperdd275a4cd119\PHP_CodeSniffer\Ruleset;
use _PhpScoperdd275a4cd119\PHP_CodeSniffer\Tests\ConfigDouble;
use _PhpScoperdd275a4cd119\PHP_CodeSniffer\Tests\Standards\AbstractSniffUnitTest;
/**
 * Unit test class for the Syntax sniff.
 *
...
final class SyntaxUnitTest extends AbstractSniffUnitTest
{
    ...
    public function dataStdIn()
    {
        ...
        return ['No syntax errors' => ['<?php $array = [1, 2, 3];', 0, []], 'One syntax error' => ['<?php $array = [1, 2, 3; // Missing closing bracket.', 1, [1 => [1 => [0 => ['message' => $errorMessage, 'source' => 'Generic.PHP.Syntax.PHPSyntax', 'listener' => '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\Generic\Sniffs\PHP\SyntaxSniff', 'severity' => 5, 'fixable' => \false]]]]], 'Single error reported even when there is more than one syntax error in the file' => ['<?php $array = [1, 2, 3; // Missing closing bracket.
                $anotherArray = [4, 5, 6; // Another missing closing bracket.', 1, [1 => [1 => [0 => ['message' => $errorMessage, 'source' => 'Generic.PHP.Syntax.PHPSyntax', 'listener' => '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\Generic\Sniffs\PHP\SyntaxSniff', 'severity' => 5, 'fixable' => \false]]]]]];
    }
    //end dataStdIn()
}
//end class
