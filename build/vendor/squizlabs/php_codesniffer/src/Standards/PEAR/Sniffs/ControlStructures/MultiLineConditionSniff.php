 ...
 */
namespace _PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\PEAR\Sniffs\ControlStructures;
...
class MultiLineConditionSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[$openBrace]['line'] > $tokens[$closeBracket]['line']) {
            ...
            $length = 0;
        } else if ($openBrace === $closeBracket + 2 && $tokens[$closeBracket + 1]['code'] === \T_WHITESPACE) {
