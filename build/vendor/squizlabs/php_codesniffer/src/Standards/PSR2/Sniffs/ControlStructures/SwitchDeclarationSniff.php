 ...
 */
namespace _PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\PSR2\Sniffs\ControlStructures;
    ...
    private function findNestedTerminator($phpcsFile, $stackPtr, $end)
    {
        ...
        if ($tokens[$lastToken]['code'] === T_CLOSE_CURLY_BRACKET) {
            ...
            do {
                ...
                } else if ($tokens[$prevToken]['code'] === \T_ELSEIF || $tokens[$prevToken]['code'] === \T_ELSE) {
