 ...
 */
namespace _PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\Squiz\Sniffs\Commenting;

use _PhpScoperdd275a4cd119\PHP_CodeSniffer\Config;
use _PhpScoperdd275a4cd119\PHP_CodeSniffer\Files\File;
use _PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\PEAR\Sniffs\Commenting\FunctionCommentSniff as PEARFunctionCommentSniff;
        ...
        if ($return !== null) {
            ...
            if (empty($content) === \true || $tokens[$return + 2]['code'] !== T_DOC_COMMENT_STRING) {
                ...
                if ($returnType === 'void') {
                    ...
                    //end if
                } else if ($returnType !== 'mixed' && $returnType !== 'never' && in_array('void', $typeNames, \true) === \false) {
        ...
        foreach ($params as $pos => $param) {
            ...
            foreach ($typeNames as $typeName) {
                ...
                if (strpos($suggestedName, 'array') !== \false || substr($suggestedName, -2) === '[]') {
                    ...
                    $suggestedTypeHint = 'callable';
                } else if (in_array($suggestedName, Common::$allowedTypes, \true) === \false) {
                ...
                if ($suggestedTypeHint !== '' && isset($realParams[$pos]) === \true && $param['var'] !== '') {
                    ...
                    //end if
                } else if ($suggestedTypeHint === '' && isset($realParams[$pos]) === \true) {
                    $typeHint = $realParams[$pos]['type_hint'];
                    if ($typeHint !== '') {
