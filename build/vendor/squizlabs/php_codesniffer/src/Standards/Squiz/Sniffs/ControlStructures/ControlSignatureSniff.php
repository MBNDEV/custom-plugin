 ...
 */
namespace _PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\Squiz\Sniffs\ControlStructures;
...
class ControlSignatureSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        } else if ($tokens[$stackPtr]['code'] === \T_ELSE || $tokens[$stackPtr]['code'] === \T_ELSEIF || $tokens[$stackPtr]['code'] === \T_CATCH || $tokens[$stackPtr]['code'] === \T_FINALLY) {
            if (isset($tokens[$stackPtr]['scope_opener']) === \true && $tokens[$tokens[$stackPtr]['scope_opener']]['code'] === T_COLON) {
