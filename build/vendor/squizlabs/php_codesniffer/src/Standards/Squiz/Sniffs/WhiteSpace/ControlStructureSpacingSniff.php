 ...
 */
namespace _PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\Squiz\Sniffs\WhiteSpace;
...
class ControlStructureSpacingSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        } else if ($tokens[$trailingContent]['code'] !== \T_ELSE && $tokens[$trailingContent]['code'] !== \T_ELSEIF && $tokens[$trailingContent]['code'] !== \T_CATCH && $tokens[$trailingContent]['code'] !== \T_FINALLY && $tokens[$trailingContent]['line'] === $tokens[$scopeCloser]['line'] + 1) {
