 ...
 */
namespace _PhpScoperdd275a4cd119\PHP_CodeSniffer\Tests\Core\Files\File;

use _PhpScoperdd275a4cd119\PHP_CodeSniffer\Tests\Core\AbstractMethodUnitTest;
/**
 * Tests for the \PHP_CodeSniffer\Files\File::findExtendedClassName method.
 *
...
final class FindExtendedClassNameTest extends AbstractMethodUnitTest
{
    ...
    {
        return ['class does not extend' => ['identifier' => '/* testNonExtendedClass */', 'expected' => \false], 'class extends unqualified class' => ['identifier' => '/* testExtendsUnqualifiedClass */', 'expected' => 'testFECNClass'], 'class extends fully qualified class' => ['identifier' => '/* testExtendsFullyQualifiedClass */', 'expected' => '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Tests\Core\File\testFECNClass'], 'class extends partially qualified class' => ['identifier' => '/* testExtendsPartiallyQualifiedClass */', 'expected' => '_PhpScoperdd275a4cd119\Core\File\RelativeClass'], 'interface does not extend' => ['identifier' => '/* testNonExtendedInterface */', 'expected' => \false], 'interface extends unqualified interface' => ['identifier' => '/* testInterfaceExtendsUnqualifiedInterface */', 'expected' => 'testFECNInterface'], 'interface extends fully qualified interface' => ['identifier' => '/* testInterfaceExtendsFullyQualifiedInterface */', 'expected' => '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Tests\Core\File\testFECNInterface'], 'anon class extends unqualified class' => ['identifier' => '/* testExtendedAnonClass */', 'expected' => 'testFECNExtendedAnonClass'], 'class does not extend but contains anon class which extends' => ['identifier' => '/* testNestedExtendedClass */', 'expected' => \false], 'anon class extends, nested in non-extended class' => ['identifier' => '/* testNestedExtendedAnonClass */', 'expected' => 'testFECNAnonClass'], 'class extends and implements' => ['identifier' => '/* testClassThatExtendsAndImplements */', 'expected' => 'testFECNClass'], 'class implements and extends' => ['identifier' => '/* testClassThatImplementsAndExtends */', 'expected' => 'testFECNClass'], 'interface extends multiple interfaces (not supported)' => ['identifier' => '/* testInterfaceMultiExtends */', 'expected' => '_PhpScoperdd275a4cd119\Package\FooInterface'], 'readonly anon class extends fully qualified class' => ['identifier' => '/* testExtendedReadonlyAnonClass */', 'expected' => '_PhpScoperdd275a4cd119\Fully\Qualified\MyClass'], 'anon class with attribute extends partially qualified class' => ['identifier' => '/* testExtendedAnonClassWithAttributes */', 'expected' => '_PhpScoperdd275a4cd119\Partially\Qualified\MyClass'], 'parse error - extends keyword, but no class name' => ['identifier' => '/* testMissingExtendsName */', 'expected' => \false], 'parse error - live coding - no curly braces' => ['identifier' => '/* testParseError */', 'expected' => \false]];
    }
