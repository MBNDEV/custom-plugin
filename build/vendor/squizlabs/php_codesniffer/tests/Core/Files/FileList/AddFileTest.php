...
final class AddFileTest extends AbstractFileListTestCase
{
    ...
    public function testAddFile($fileName, $passFileObject = \false)
    {
        ...
        if ($fileObject instanceof File) {
            ...
            $this->assertInstanceOf('_PhpScoperdd275a4cd119\PHP_CodeSniffer\Files\File', $fileListArray[$fileName], 'File object not found in list');
        }
    }
    //end testAddFile()
    /**
    ...
    {
        return ['Regular file' => ['fileName' => 'test1.php'], 'STDIN' => ['fileName' => 'STDIN'], 'Regular file with file object' => ['fileName' => 'test1.php', 'passFileObject' => \true]];
    }
    //end dataAddFile()
    /**
