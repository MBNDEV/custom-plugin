 ...
 */
namespace _PhpScoperdd275a4cd119\PHP_CodeSniffer\Tests\Core\Files\FileList;

use _PhpScoperdd275a4cd119\PHP_CodeSniffer\Files\FileList;
/**
 * Tests for the \PHP_CodeSniffer\Files\FileList::__construct method.
 *
...
final class ConstructTest extends AbstractFileListTestCase
{
    ...
    public function testConstruct($files, $expectedFiles)
    {
        ...
        foreach ($fileListArray as $filePath => $fileObject) {
            $this->assertSame($expectedFiles[$i], $filePath, sprintf('File path mismatch: expected "%s", got "%s"', $expectedFiles[$i], $filePath));
            $this->assertInstanceOf('_PhpScoperdd275a4cd119\PHP_CodeSniffer\Files\File', $fileObject, sprintf('File object for "%s" is not an instance of PHP_CodeSniffer\Files\File', $filePath));
            $i++;
        }
    }
    //end testConstruct()
    ...
    public static function dataConstruct()
    {
        ...
        return ['No files' => ['files' => [], 'expectedFiles' => []], 'Two files' => ['files' => ['file1.php', 'file2.php'], 'expectedFiles' => ['file1.php', 'file2.php']], 'A directory' => ['files' => [$fixturesDir], 'expectedFiles' => [$fixturesDir . 'file1.php', $fixturesDir . 'file2.php']], 'Same file twice' => ['files' => ['file1.php', 'file1.php'], 'expectedFiles' => ['file1.php']], 'File and then directory containing that file' => ['files' => [$fixturesDir . 'file1.php', $fixturesDir], 'expectedFiles' => [$fixturesDir . 'file1.php', $fixturesDir . 'file2.php']]];
    }
    //end dataConstruct()
}
//end class
