 ...
 */
namespace _PhpScoperdd275a4cd119\PHP_CodeSniffer\Tests\Core\Filters;

use _PhpScoperdd275a4cd119\PHP_CodeSniffer\Config;
use _PhpScoperdd275a4cd119\PHP_CodeSniffer\Filters\GitModified;
use _PhpScoperdd275a4cd119\PHP_CodeSniffer\Tests\Core\Filters\AbstractFilterTestCase;
...
final class GitModifiedTest extends AbstractFilterTestCase
{
    ...
    public function testFileNamePassesAsBasePathWillTranslateToDirname()
    {
        ...
        $mockObj = $this->getMockedClass('_PhpScoperdd275a4cd119\PHP_CodeSniffer\Filters\GitModified', $constructorArgs, ['exec']);
