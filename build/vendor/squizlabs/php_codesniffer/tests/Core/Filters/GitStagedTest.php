...
use _PhpScoperdd275a4cd119\PHP_CodeSniffer\Filters\GitStaged;
...
final class GitStagedTest extends AbstractFilterTestCase
{
    ...
    public function testFileNamePassesAsBasePathWillTranslateToDirname()
    {
        ...
        $mockObj = $this->getMockedClass('_PhpScoperdd275a4cd119\PHP_CodeSniffer\Filters\GitStaged', $constructorArgs, ['exec']);
