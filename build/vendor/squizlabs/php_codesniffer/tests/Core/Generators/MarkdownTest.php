 ...
 */
namespace _PhpScoperdd275a4cd119\PHP_CodeSniffer\Tests\Core\Generators;

use _PhpScoperdd275a4cd119\PHP_CodeSniffer\Ruleset;
use _PhpScoperdd275a4cd119\PHP_CodeSniffer\Tests\ConfigDouble;
use _PhpScoperdd275a4cd119\PHP_CodeSniffer\Tests\Core\Generators\Fixtures\MarkdownDouble;
...
final class MarkdownTest extends TestCase
{
    ...
    public function testCallingDeprecatedMethodThrowsDeprecationNotice($methodName)
    {
        ...
        } else if (method_exists($this, 'expectExceptionMessageRegExp') === \true) {
            // PHPUnit < 8.4.0.
            $this->expectException($exceptionClass);
