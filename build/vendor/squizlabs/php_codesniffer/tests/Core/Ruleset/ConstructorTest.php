...
use _PhpScoperdd275a4cd119\PHP_CodeSniffer\Autoload;
...
final class ConstructorTest extends AbstractRulesetTestCase
{
    ...
    public static function dataStandardsAreRegisteredWithAutoloader()
    {
        ...
        $data['Additional namespaced standard'] = ['cliArgs' => [
            ...
            // is being tested here.
            '--sniffs=TestStandard.ValidSniffs.RegisterEmptyArray',
        ], 'expected' => $defaultPaths + [$extraInstalledPath => '_PhpScoperdd275a4cd119\Fixtures\TestStandard']];
        return $data;
    }
    ...
    {
        $completeSet = ['_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\Generic\Sniffs\Files\ByteOrderMarkSniff', '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\Generic\Sniffs\NamingConventions\UpperCaseConstantNameSniff', '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\Generic\Sniffs\PHP\DisallowAlternativePHPTagsSniff', '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\Generic\Sniffs\PHP\DisallowShortOpenTagSniff', '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\PSR1\Sniffs\Classes\ClassDeclarationSniff', '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\PSR1\Sniffs\Files\SideEffectsSniff', '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\PSR1\Sniffs\Methods\CamelCapsMethodNameSniff', '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\Squiz\Sniffs\Classes\ValidClassNameSniff'];
        return ['No restrictions, cache off' => ['cliArgs' => ['--standard=PSR1'], 'cache' => \false, 'expected' => $completeSet], 'Has exclusions, cache off' => ['cliArgs' => ['--standard=PSR1', '--exclude=Generic.Files.ByteOrderMark,Generic.PHP.DisallowShortOpenTag,PSR1.Files.SideEffects,Generic.PHP.DisallowAlternativePHPTags'], 'cache' => \false, 'expected' => ['_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\Generic\Sniffs\NamingConventions\UpperCaseConstantNameSniff', '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\PSR1\Sniffs\Classes\ClassDeclarationSniff', '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\PSR1\Sniffs\Methods\CamelCapsMethodNameSniff', '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\Squiz\Sniffs\Classes\ValidClassNameSniff']], 'Has sniff selection, cache off' => ['cliArgs' => ['--standard=PSR1', '--sniffs=Generic.Files.ByteOrderMark,Generic.PHP.DisallowShortOpenTag,PSR1.Files.SideEffects,Generic.PHP.DisallowAlternativePHPTags'], 'cache' => \false, 'expected' => ['_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\Generic\Sniffs\Files\ByteOrderMarkSniff', '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\Generic\Sniffs\PHP\DisallowAlternativePHPTagsSniff', '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\Generic\Sniffs\PHP\DisallowShortOpenTagSniff', '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\PSR1\Sniffs\Files\SideEffectsSniff']], 'No restrictions, cache on' => ['cliArgs' => ['--standard=PSR1'], 'cache' => \true, 'expected' => $completeSet], 'Has exclusions, cache on' => ['cliArgs' => ['--standard=PSR1', '--exclude=Generic.Files.ByteOrderMark,Generic.PHP.DisallowAlternativePHPTags,Generic.PHP.DisallowShortOpenTag,PSR1.Files.SideEffects'], 'cache' => \true, 'expected' => $completeSet]];
    }
