...
final class ExpandRulesetReferenceTest extends AbstractRulesetTestCase
{
    ...
    public function testRulesetRelativePathReferences()
    {
        ...
        $expected = ['ExternalA.CheckSomething.Valid' => '_PhpScoperdd275a4cd119\Fixtures\ExternalA\Sniffs\CheckSomething\ValidSniff', 'TestStandard.ValidSniffs.RegisterEmptyArray' => '_PhpScoperdd275a4cd119\Fixtures\TestStandard\Sniffs\ValidSniffs\RegisterEmptyArraySniff', 'ExternalB.CheckMore.Valid' => '_PhpScoperdd275a4cd119\Fixtures\ExternalB\Sniffs\CheckMore\ValidSniff'];
