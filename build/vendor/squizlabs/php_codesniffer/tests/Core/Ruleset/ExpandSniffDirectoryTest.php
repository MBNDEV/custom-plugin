...
final class ExpandSniffDirectoryTest extends TestCase
{
    ...
    public function testExpandSniffDirectory()
    {
        ...
        $expectedSniffCodes = ['MyStandard.CategoryA.FindMe' => '_PhpScoperdd275a4cd119\MyStandard\Sniffs\CategoryA\FindMeSniff', 'MyStandard.CategoryB.FindMe' => '_PhpScoperdd275a4cd119\MyStandard\Sniffs\CategoryB\FindMeSniff'];
