...
final class PopulateTokenListenersNamingConventionsTest extends TestCase
{
    ...
    public function testBrokenNamingConventions()
    {
        ...
        $expectedSniffCodes = ['..NoNamespace' => 'NoNamespaceSniff', '.Sniffs.MissingCategoryDir' => '_PhpScoperdd275a4cd119\BrokenNamingConventions\Sniffs\MissingCategoryDirSniff', '.Sniffs.PartialNamespace' => '_PhpScoperdd275a4cd119\Sniffs\PartialNamespaceSniff', 'BrokenNamingConventions.Category.' => '_PhpScoperdd275a4cd119\BrokenNamingConventions\Sniffs\Category\Sniff', 'BrokenNamingConventions.Sniffs.CategoryCalledSniffs' => '_PhpScoperdd275a4cd119\BrokenNamingConventions\Sniffs\Sniffs\CategoryCalledSniffsSniff', 'Generic.PHP.BacktickOperator' => '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\Generic\Sniffs\PHP\BacktickOperatorSniff', 'Sniffs.SubDir.TooDeeplyNested' => '_PhpScoperdd275a4cd119\BrokenNamingConventions\Sniffs\Category\SubDir\TooDeeplyNestedSniff'];
