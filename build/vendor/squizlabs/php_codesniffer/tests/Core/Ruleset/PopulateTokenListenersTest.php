...
final class PopulateTokenListenersTest extends AbstractRulesetTestCase
{
    ...
    public function testSniffWhereRegisterDoesNotReturnAnArrayThrowsException()
    {
        ...
        $config = new ConfigDouble(["--standard={$standard}"]);
        $sniffClass = '_PhpScoperdd275a4cd119\Fixtures\TestStandard\Sniffs\InvalidSniffs\RegisterNoArraySniff';
    ...
    {
        $target = '_PhpScoperdd275a4cd119\Fixtures\TestStandard\Sniffs\ValidSniffs\RegisterEmptyArraySniff';
    ...
    {
        return ['TestStandard.SupportedTokenizers.ListensForPHPAndCSSAndJS' => ['sniffClass' => '_PhpScoperdd275a4cd119\Fixtures\TestStandard\Sniffs\SupportedTokenizers\ListensForPHPAndCSSAndJSSniff', 'expectedCount' => 2], 'Generic.NamingConventions.UpperCaseConstantName' => ['sniffClass' => '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\Generic\Sniffs\NamingConventions\UpperCaseConstantNameSniff', 'expectedCount' => 2], 'PSR1.Files.SideEffects' => ['sniffClass' => '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\PSR1\Sniffs\Files\SideEffectsSniff', 'expectedCount' => 1], 'PSR12.ControlStructures.BooleanOperatorPlacement' => ['sniffClass' => '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\PSR12\Sniffs\ControlStructures\BooleanOperatorPlacementSniff', 'expectedCount' => 5], 'Squiz.ControlStructures.ForEachLoopDeclaration' => ['sniffClass' => '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\Squiz\Sniffs\ControlStructures\ForEachLoopDeclarationSniff', 'expectedCount' => 1], 'TestStandard.Deprecated.WithReplacement' => ['sniffClass' => '_PhpScoperdd275a4cd119\Fixtures\TestStandard\Sniffs\Deprecated\WithReplacementSniff', 'expectedCount' => 1], 'TestStandard.ValidSniffs.RegisterEmptyArray' => ['sniffClass' => '_PhpScoperdd275a4cd119\Fixtures\TestStandard\Sniffs\ValidSniffs\RegisterEmptyArraySniff', 'expectedCount' => 0]];
    }
    ...
    {
        $sniffClass = '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\Generic\Sniffs\NamingConventions\UpperCaseConstantNameSniff';
    ...
    {
        return ['Sniff with single property being set' => ['sniffClass' => '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\PSR12\Sniffs\ControlStructures\BooleanOperatorPlacementSniff', 'propertyName' => 'allowOnly', 'expected' => 'first'], 'Sniff with multiple properties being set - first property' => ['sniffClass' => '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\Squiz\Sniffs\ControlStructures\ForEachLoopDeclarationSniff', 'propertyName' => 'requiredSpacesAfterOpen', 'expected' => '3'], 'Sniff with multiple properties being set - second property' => ['sniffClass' => '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\Squiz\Sniffs\ControlStructures\ForEachLoopDeclarationSniff', 'propertyName' => 'requiredSpacesBeforeClose', 'expected' => '8']];
    }
    ...
    {
        $exclude = '_PhpScoperdd275a4cd119\Fixtures\TestStandard\Sniffs\SupportedTokenizers\ListensForPHPAndCSSAndJSSniff';
        $expected = ['PHP' => 'PHP'];
        foreach (self::$ruleset->tokenListeners as $token => $listeners) {
            $this->assertTrue(is_array($listeners), 'No listeners registered for token' . Tokens::tokenName($token));
            foreach ($listeners as $className => $details) {
    ...
    {
        $sniffClass = '_PhpScoperdd275a4cd119\Fixtures\TestStandard\Sniffs\SupportedTokenizers\ListensForPHPAndCSSAndJSSniff';
    ...
    {
        $exclude = '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\Generic\Sniffs\NamingConventions\UpperCaseConstantNameSniff';
        foreach (self::$ruleset->tokenListeners as $token => $listeners) {
            $this->assertTrue(is_array($listeners), 'No listeners registered for token' . Tokens::tokenName($token));
            foreach ($listeners as $className => $details) {
                if ($className === $exclude) {
    ...
    {
        $exclude = '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\PSR1\Sniffs\Files\SideEffectsSniff';
        foreach (self::$ruleset->tokenListeners as $token => $listeners) {
            $this->assertTrue(is_array($listeners), 'No listeners registered for token' . Tokens::tokenName($token));
            foreach ($listeners as $className => $details) {
                if ($className === $exclude) {
    ...
    {
        return ['Sniff with <include-pattern>s in the ruleset - first token' => ['token' => \T_STRING, 'sniffClass' => '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\Generic\Sniffs\NamingConventions\UpperCaseConstantNameSniff', 'patternType' => 'include'], 'Sniff with <include-pattern>s in the ruleset - second token' => ['token' => \T_CONST, 'sniffClass' => '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\Generic\Sniffs\NamingConventions\UpperCaseConstantNameSniff', 'patternType' => 'include'], 'Sniff with <exclude-pattern>s in the ruleset' => ['token' => \T_OPEN_TAG, 'sniffClass' => '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\PSR1\Sniffs\Files\SideEffectsSniff', 'patternType' => 'ignore']];
    }
