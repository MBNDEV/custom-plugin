...
final class ProcessRuleShouldProcessElementTest extends AbstractRulesetTestCase
{
    ...
    public function testShouldProcessPropertiesCsonly()
    {
        ...
        $csSniffClass = '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\Generic\Sniffs\Arrays\ArrayIndentSniff';
        $cbfSniffClass = '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\PSR2\Sniffs\Classes\ClassDeclarationSniff';
        $propertyName = 'indent';
        $propertyDefault = 4;
        $propertyChanged = '2';
    ...
    public function testShouldProcessPropertyCsonly()
    {
        ...
        $sniffClass = '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\Generic\Sniffs\WhiteSpace\ScopeIndentSniff';
