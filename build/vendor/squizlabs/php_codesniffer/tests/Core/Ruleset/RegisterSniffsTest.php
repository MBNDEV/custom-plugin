...
final class RegisterSniffsTest extends TestCase
{
    ...
    {
        $restrictions = ['_PhpScoperdd275a4cd119\psr1\sniffs\classes\classdeclarationsniff' => \true, '_PhpScoperdd275a4cd119\psr1\sniffs\files\sideeffectssniff' => \true, '_PhpScoperdd275a4cd119\psr1\sniffs\methods\camelcapsmethodnamesniff' => \true];
        $expected = ['_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\PSR1\Sniffs\Classes\ClassDeclarationSniff', '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\PSR1\Sniffs\Files\SideEffectsSniff', '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\PSR1\Sniffs\Methods\CamelCapsMethodNameSniff'];
    ...
    public function testRegisteredSniffsWithExclusions()
    {
        ...
        $expected = ['_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\Generic\Sniffs\Files\ByteOrderMarkSniff', '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\Generic\Sniffs\NamingConventions\UpperCaseConstantNameSniff', '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\Generic\Sniffs\PHP\DisallowAlternativePHPTagsSniff', '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\Generic\Sniffs\PHP\DisallowShortOpenTagSniff', '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\Squiz\Sniffs\Classes\ValidClassNameSniff'];
    ...
    {
        $restrictions = ['_PhpScoperdd275a4cd119\generic\sniffs\namingconventions\uppercaseconstantnamesniff' => \true, '_PhpScoperdd275a4cd119\generic\sniffs\php\disallowalternativephptagssniff' => \true, '_PhpScoperdd275a4cd119\generic\sniffs\php\disallowshortopentagsniff' => \true, '_PhpScoperdd275a4cd119\psr1\sniffs\classes\classdeclarationsniff' => \true, '_PhpScoperdd275a4cd119\squiz\sniffs\classes\validclassnamesniff' => \true];
        $exclusions = ['_PhpScoperdd275a4cd119\squiz\sniffs\classes\validclassnamesniff' => \true, '_PhpScoperdd275a4cd119\generic\sniffs\php\disallowalternativephptagssniff' => \true, '_PhpScoperdd275a4cd119\generic\sniffs\namingconventions\uppercaseconstantnamesniff' => \true];
        $expected = ['_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\Generic\Sniffs\PHP\DisallowShortOpenTagSniff', '_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\PSR1\Sniffs\Classes\ClassDeclarationSniff'];
