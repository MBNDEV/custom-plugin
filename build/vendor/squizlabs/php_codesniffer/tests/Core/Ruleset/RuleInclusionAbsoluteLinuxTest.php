...
final class RuleInclusionAbsoluteLinuxTest extends TestCase
{
    ...
    public function testLinuxStylePathRuleInclusion()
    {
        ...
        $this->assertSame('_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\Generic\Sniffs\Formatting\SpaceAfterNotSniff', $this->ruleset->sniffCodes['Generic.Formatting.SpaceAfterNot']);
