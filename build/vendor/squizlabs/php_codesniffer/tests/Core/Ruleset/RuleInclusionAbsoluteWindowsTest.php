...
final class RuleInclusionAbsoluteWindowsTest extends TestCase
{
    ...
    public function testWindowsStylePathRuleInclusion()
    {
        ...
        $this->assertSame('_PhpScoperdd275a4cd119\PHP_CodeSniffer\Standards\Generic\Sniffs\Formatting\SpaceAfterCastSniff', $this->ruleset->sniffCodes['Generic.Formatting.SpaceAfterCast']);
