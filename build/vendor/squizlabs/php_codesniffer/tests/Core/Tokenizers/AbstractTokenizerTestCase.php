 ...
 */
namespace _PhpScoperdd275a4cd119\PHP_CodeSniffer\Tests\Core\Tokenizers;
...
abstract class AbstractTokenizerTestCase extends TestCase
{
    ...
    {
        $property = new ReflectionProperty('_PhpScoperdd275a4cd119\PHP_CodeSniffer\Tokenizers\PHP', 'resolveTokenCache');
