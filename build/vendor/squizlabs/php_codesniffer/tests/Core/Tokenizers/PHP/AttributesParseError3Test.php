...
final class AttributesParseError3Test extends AbstractTokenizerTestCase
{
    ...
    public function testInvalidAttribute()
    {
        ...
        $expectedTokenCodes = ['T_ATTRIBUTE', 'T_STRING', 'T_OPEN_PARENTHESIS', 'T_LNUMBER', 'T_CLOSE_PARENTHESIS', 'T_COMMA', 'T_WHITESPACE', 'T_STRING', 'T_OPEN_PARENTHESIS', 'T_WHITESPACE', 'T_WHITESPACE', 'T_PUBLIC', 'T_WHITESPACE', 'T_FINAL', 'T_WHITESPACE', 'T_FUNCTION'];
        $length = count($expectedTokenCodes);
        $map = array_map(function ($token) {
