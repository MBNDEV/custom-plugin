...
final class AttributesParseError4Test extends AbstractTokenizerTestCase
{
    ...
    public function testInvalidAttribute()
    {
        ...
        $expectedTokenCodesAttribute1 = ['T_ATTRIBUTE', 'T_STRING', 'T_ATTRIBUTE_END', 'T_WHITESPACE'];
        $lengthAttribute1 = count($expectedTokenCodesAttribute1);
        $map = array_map(function ($token) use ($attribute, $lengthAttribute1) {
        ...
        $expectedTokenCodesAttribute2 = ['T_ATTRIBUTE', 'T_STRING', 'T_WHITESPACE', 'T_FUNCTION'];
