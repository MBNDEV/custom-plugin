 ...
 */
namespace _PhpScoperdd275a4cd119\PHP_CodeSniffer\Tests\Core\Tokenizers\PHP;

use _PhpScoperdd275a4cd119\PHP_CodeSniffer\Util\Tokens;
use _PhpScoperdd275a4cd119\PHP_CodeSniffer\Tests\Core\Tokenizers\AbstractTokenizerTestCase;
final class AttributesTest extends AbstractTokenizerTestCase
{
    ...
    public function testAttribute($testMarker, $tokenCodes, $expectedFirstAfter)
    {
        ...
        $actualFirstAfter = $this->phpcsFile->findNext(Tokens::$emptyTokens, $closer + 1, null, \true);
    ...
    {
        return ['parameter attribute; single, inline' => ['testMarker' => '/* testSingleAttributeOnParameter */', 'position' => 4, 'tokenCodes' => [\T_STRING], 'expectedFirstAfter' => \T_STRING, 'expectedFirstAfterContent' => 'int'], 'parameter attribute; multiple comma separated, inline' => ['testMarker' => '/* testMultipleAttributesOnParameter */', 'position' => 4, 'tokenCodes' => [\T_STRING, T_COMMA, \T_WHITESPACE, \T_STRING, T_OPEN_PARENTHESIS, \T_COMMENT, \T_WHITESPACE, \T_CONSTANT_ENCAPSED_STRING, T_CLOSE_PARENTHESIS], 'expectedFirstAfter' => \T_STRING, 'expectedFirstAfterContent' => 'array'], 'parameter attribute; single, multiline' => ['testMarker' => '/* testMultilineAttributesOnParameter */', 'position' => 4, 'tokenCodes' => [\T_WHITESPACE, \T_WHITESPACE, \T_STRING, T_OPEN_PARENTHESIS, \T_WHITESPACE, \T_WHITESPACE, \T_CONSTANT_ENCAPSED_STRING, \T_WHITESPACE, \T_WHITESPACE, T_CLOSE_PARENTHESIS, \T_WHITESPACE, \T_WHITESPACE], 'expectedFirstAfter' => T_NULL, 'expectedFirstAfterContent' => 'null']];
    }
