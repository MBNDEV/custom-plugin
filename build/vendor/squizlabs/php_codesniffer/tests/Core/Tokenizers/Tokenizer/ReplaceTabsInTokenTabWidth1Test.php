 ...
 */
namespace _PhpScoperdd275a4cd119\PHP_CodeSniffer\Tests\Core\Tokenizers\Tokenizer;
...
'], 'Inline: tab becomes 2 spaces in comment (with tabwidth 4)' => ['length' => 52, 'content' => '/* -12 With tabwidth 4, the tab size should be 2. */', 'orig_content' => '/* -12	With tabwidth 4, the tab size should be 2. */'], 'Inline: tab becomes 3 spaces in doc comment string (with tabwidth 4)' => ['length' => 45, 'content' => '-1 With tabwidth 4, the tab size should be 3.', 'orig_content' => '-1	With tabwidth 4, the tab size should be 3.'], 'Inline: tab becomes 4 spaces in comment (with tabwidth 4)' => ['length' => 47, 'content' => '// - With tabwidth 4, the tab size should be 4.
