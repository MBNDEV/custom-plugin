...
use _PhpScoperdd275a4cd119\Symfony\Component\Console\Output\AnsiColorMode;
class Terminal
{
    ...
    public static function hasSttyAvailable(): bool
    {
        ...
        if (!\function_exists('shell_exec') && !\function_exists('_PhpScoperdd275a4cd119\shell_exec')) {
            return \false;
        }
    ...
    {
        if (!\function_exists('proc_open') && !\function_exists('_PhpScoperdd275a4cd119\proc_open')) {
            return null;
        }
