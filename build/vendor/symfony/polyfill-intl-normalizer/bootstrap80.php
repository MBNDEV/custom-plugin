 ...
 */
use _PhpScoperdd275a4cd119\Symfony\Polyfill\Intl\Normalizer as p;
if (!\function_exists('normalizer_is_normalized') && !\function_exists('_PhpScoperdd275a4cd119\normalizer_is_normalized')) {
...
if (!\function_exists('normalizer_normalize') && !\function_exists('_PhpScoperdd275a4cd119\normalizer_normalize')) {
