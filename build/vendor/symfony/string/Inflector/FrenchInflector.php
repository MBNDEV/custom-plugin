 ...
 */
namespace _PhpScoperdd275a4cd119\Symfony\Component\String\Inflector;
...
final class FrenchInflector implements InflectorInterface
{
    ...
    private const PLURALIZE_REGEXP = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', '_PhpScoperdd275a4cd119\mes\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', '_PhpScoperdd275a4cd119\Mes\2s'],
    ];
    /**
    ...
    private const SINGULARIZE_REGEXP = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', '_PhpScoperdd275a4cd119\ma\1'],
        ['/^Mes(dame|demoiselle)s$/', '_PhpScoperdd275a4cd119\Ma\1'],
        ['/^mes(sieur|seigneur)s$/', '_PhpScoperdd275a4cd119\mon\1'],
        ['/^Mes(sieur|seigneur)s$/', '_PhpScoperdd275a4cd119\Mon\1'],
        // Default rule
        ['/s$/i', ''],
    ];
