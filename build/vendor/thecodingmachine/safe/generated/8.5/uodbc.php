...
use _PhpScoperdd275a4cd119\Safe\Exceptions\UodbcException;
/**
 ...
 *
 */
function odbc_autocommit(\_PhpScoperdd275a4cd119\Odbc\Connection $odbc, ?bool $enable = null)
{
    error_clear_last();
    if ($enable !== null) {
 ...
 *
 */
function odbc_columnprivileges(\_PhpScoperdd275a4cd119\Odbc\Connection $odbc, string $catalog, string $schema, string $table, string $column)
{
    error_clear_last();
 ...
 *
 */
function odbc_columns(\_PhpScoperdd275a4cd119\Odbc\Connection $odbc, ?string $catalog = null, ?string $schema = null, ?string $table = null, ?string $column = null)
{
    error_clear_last();
    if ($column !== null) {
 ...
 *
 */
function odbc_commit(\_PhpScoperdd275a4cd119\Odbc\Connection $odbc): void
{
    error_clear_last();
 ...
 *
 */
function odbc_connect(string $dsn, ?string $user = null, ?string $password = null, int $cursor_option = \SQL_CUR_USE_DRIVER): \_PhpScoperdd275a4cd119\Odbc\Connection
{
    error_clear_last();
 ...
 *
 */
function odbc_cursor(\_PhpScoperdd275a4cd119\Odbc\Result $statement): string
{
    error_clear_last();
 ...
 *
 */
function odbc_data_source(\_PhpScoperdd275a4cd119\Odbc\Connection $odbc, int $fetch_type): array
{
    error_clear_last();
 ...
 *
 */
function odbc_exec(\_PhpScoperdd275a4cd119\Odbc\Connection $odbc, string $query): \_PhpScoperdd275a4cd119\Odbc\Result
{
    error_clear_last();
 ...
 *
 */
function odbc_execute(\_PhpScoperdd275a4cd119\Odbc\Result $statement, array $params = []): void
{
    error_clear_last();
 ...
 *
 */
function odbc_fetch_into(\_PhpScoperdd275a4cd119\Odbc\Result $statement, ?array &$array, ?int $row = null): int
{
    error_clear_last();
    if ($row !== null) {
 ...
 *
 */
function odbc_field_len(\_PhpScoperdd275a4cd119\Odbc\Result $statement, int $field): int
{
    error_clear_last();
 ...
 *
 */
function odbc_field_name(\_PhpScoperdd275a4cd119\Odbc\Result $statement, int $field): string
{
    error_clear_last();
 ...
 *
 */
function odbc_field_num(\_PhpScoperdd275a4cd119\Odbc\Result $statement, string $field): int
{
    error_clear_last();
 ...
 *
 */
function odbc_field_scale(\_PhpScoperdd275a4cd119\Odbc\Result $statement, int $field): int
{
    error_clear_last();
 ...
 *
 */
function odbc_field_type(\_PhpScoperdd275a4cd119\Odbc\Result $statement, int $field): string
{
    error_clear_last();
 ...
 *
 */
function odbc_foreignkeys(\_PhpScoperdd275a4cd119\Odbc\Connection $odbc, string $pk_catalog, string $pk_schema, string $pk_table, string $fk_catalog, string $fk_schema, string $fk_table)
{
    error_clear_last();
 ...
 *
 */
function odbc_gettypeinfo(\_PhpScoperdd275a4cd119\Odbc\Connection $odbc, int $data_type = 0)
{
    error_clear_last();
 ...
 *
 */
function odbc_longreadlen(\_PhpScoperdd275a4cd119\Odbc\Result $statement, int $length): bool
{
    error_clear_last();
 ...
 *
 */
function odbc_num_fields(\_PhpScoperdd275a4cd119\Odbc\Result $statement): int
{
    error_clear_last();
 ...
 *
 */
function odbc_pconnect(string $dsn, ?string $user = null, ?string $password = null, int $cursor_option = \SQL_CUR_USE_DRIVER): \_PhpScoperdd275a4cd119\Odbc\Connection
{
    error_clear_last();
    if ($cursor_option !== \SQL_CUR_USE_DRIVER) {
 ...
 *
 */
function odbc_prepare(\_PhpScoperdd275a4cd119\Odbc\Connection $odbc, string $query): \_PhpScoperdd275a4cd119\Odbc\Result
{
    error_clear_last();
 ...
 *
 */
function odbc_primarykeys(\_PhpScoperdd275a4cd119\Odbc\Connection $odbc, string $catalog, string $schema, string $table)
{
    error_clear_last();
 ...
 *
 */
function odbc_procedures($odbc, ?string $catalog = null, ?string $schema = null, ?string $procedure = null): \_PhpScoperdd275a4cd119\Odbc\Result
{
    error_clear_last();
    if ($procedure !== null) {
 ...
 *
 */
function odbc_result_all(\_PhpScoperdd275a4cd119\Odbc\Result $statement, string $format = ""): int
{
    error_clear_last();
 ...
 *
 */
function odbc_result(\_PhpScoperdd275a4cd119\Odbc\Result $statement, $field)
{
    error_clear_last();
 ...
 *
 */
function odbc_rollback(\_PhpScoperdd275a4cd119\Odbc\Connection $odbc): void
{
    error_clear_last();
 ...
 *
 */
function odbc_specialcolumns(\_PhpScoperdd275a4cd119\Odbc\Connection $odbc, int $type, string $catalog, string $schema, string $table, int $scope, int $nullable)
{
    error_clear_last();
 ...
 *
 */
function odbc_statistics(\_PhpScoperdd275a4cd119\Odbc\Connection $odbc, string $catalog, string $schema, string $table, int $unique, int $accuracy)
{
    error_clear_last();
 ...
 *
 */
function odbc_tableprivileges(\_PhpScoperdd275a4cd119\Odbc\Connection $odbc, string $catalog, string $schema, string $table)
{
    error_clear_last();
 ...
 *
 */
function odbc_tables(\_PhpScoperdd275a4cd119\Odbc\Connection $odbc, ?string $catalog = null, ?string $schema = null, ?string $table = null, ?string $types = null): \_PhpScoperdd275a4cd119\Odbc\Result
{
    error_clear_last();
    if ($types !== null) {
