 ...
 */
namespace _PhpScoperdd275a4cd119\WordPressCS\WordPress;
    ...
    public function is_targetted_token($stackPtr)
    {
        ...
        if (\in_array($token['code'], array(\T_NEW, \T_EXTENDS, \T_IMPLEMENTS), \true)) {
            if (\T_NEW === $token['code']) {
                ...
                if (\false === $nextNonEmpty || \in_array($this->tokens[$nextNonEmpty]['code'], array(\T_READONLY, \T_ANON_CLASS, \T_ATTRIBUTE), \true)) {
