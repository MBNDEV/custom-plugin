 ...
 */
namespace _PhpScoperdd275a4cd119\WordPressCS\WordPress\Helpers;
...
use _PhpScoperdd275a4cd119\WordPressCS\WordPress\Helpers\UnslashingFunctionsHelper;
/**
...
trait SanitizationHelperTrait
{
     ...
     */
    private $unslashingSanitizingFunctions = array('absint' => \true, 'boolval' => \true, 'count' => \true, 'doubleval' => \true, 'floatval' => \true, 'intval' => \true, 'rest_sanitize_boolean' => \true, 'sanitize_key' => \true, 'sanitize_locale_name' => \true, 'sizeof' => \true);
    /**
    ...
    final public function is_sanitized(File $phpcsFile, $stackPtr, $unslash_callback = null)
    {
        ...
        if (ArrayWalkingFunctionsHelper::is_array_walking_function($functionName)) {
            ...
            if (!empty($callback)) {
                 ...
                 */
                $first_non_empty = $phpcsFile->findNext(Tokens::$emptyTokens, $callback['start'], $callback['end'] + 1, \true);
        ...
        if (\false === $is_unslashed && \true === $require_unslash && !$this->is_sanitizing_and_unslashing_function($functionName)) {
            call_user_func($unslash_callback, $phpcsFile, $stackPtr);
        }
