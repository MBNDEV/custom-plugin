...
final class ValidationHelper
{
     ...
     */
    private static $targets = array(\T_ISSET => 'construct', \T_EMPTY => 'construct', \T_STRING => 'function_call', \T_COALESCE => 'coalesce', \T_COALESCE_EQUAL => 'coalesce');
    /**
    ...
    public static function is_validated(File $phpcsFile, $stackPtr, $array_keys = array(), $in_condition_only = \false)
    {
        ...
        for ($i = $scope_start + 1; $i < $scope_end; $i++) {
            ...
            if (\T_FN === $tokens[$i]['code'] && isset($tokens[$i]['scope_closer']) && $tokens[$i]['scope_closer'] < $scope_end) {
