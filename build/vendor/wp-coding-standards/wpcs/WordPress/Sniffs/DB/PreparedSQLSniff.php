    ...
    public function process_token($stackPtr)
    {
        ...
        for ($this->i; $this->i < $this->end; $this->i++) {
            ...
            if (\T_DOUBLE_QUOTED_STRING === $this->tokens[$this->i]['code'] || \T_HEREDOC === $this->tokens[$this->i]['code']) {
                $bad_variables = array_filter(TextStrings::getEmbeds($this->tokens[$this->i]['content']), static function ($symbol) {
            ...
            if (\T_STRING === $this->tokens[$this->i]['code']) {
                ...
                if (isset($this->SQLEscapingFunctions[$content_lowercase]) || isset($this->SQLAutoEscapedFunctions[$content_lowercase])) {
