 ...
 */
namespace _PhpScoperdd275a4cd119\WordPressCS\WordPress\Sniffs\NamingConventions;

use _PhpScoperdd275a4cd119\PHP_CodeSniffer\Util\Tokens;
use _PhpScoperdd275a4cd119\PHPCSUtils\BackCompat\Helper;
use _PhpScoperdd275a4cd119\PHPCSUtils\Tokens\Collections;
use _PhpScoperdd275a4cd119\PHPCSUtils\Utils\Conditions;
use _PhpScoperdd275a4cd119\PHPCSUtils\Utils\Context;
use _PhpScoperdd275a4cd119\PHPCSUtils\Utils\FunctionDeclarations;
use _PhpScoperdd275a4cd119\PHPCSUtils\Utils\Lists;
use _PhpScoperdd275a4cd119\PHPCSUtils\Utils\MessageHelper;
use _PhpScoperdd275a4cd119\PHPCSUtils\Utils\Namespaces;
use _PhpScoperdd275a4cd119\PHPCSUtils\Utils\ObjectDeclarations;
use _PhpScoperdd275a4cd119\PHPCSUtils\Utils\Parentheses;
use _PhpScoperdd275a4cd119\PHPCSUtils\Utils\PassedParameters;
use _PhpScoperdd275a4cd119\PHPCSUtils\Utils\Scopes;
use _PhpScoperdd275a4cd119\PHPCSUtils\Utils\TextStrings;
use _PhpScoperdd275a4cd119\PHPCSUtils\Utils\Variables;
use _PhpScoperdd275a4cd119\WordPressCS\WordPress\AbstractFunctionParameterSniff;
use _PhpScoperdd275a4cd119\WordPressCS\WordPress\Helpers\DeprecationHelper;
use _PhpScoperdd275a4cd119\WordPressCS\WordPress\Helpers\IsUnitTestTrait;
use _PhpScoperdd275a4cd119\WordPressCS\WordPress\Helpers\ListHelper;
use _PhpScoperdd275a4cd119\WordPressCS\WordPress\Helpers\RulesetPropertyHelper;
use _PhpScoperdd275a4cd119\WordPressCS\WordPress\Helpers\VariableHelper;
use _PhpScoperdd275a4cd119\WordPressCS\WordPress\Helpers\WPGlobalVariablesHelper;
use _PhpScoperdd275a4cd119\WordPressCS\WordPress\Helpers\WPHookHelper;
/**
...
final class PrefixAllGlobalsSniff extends AbstractFunctionParameterSniff
{
    ...
    protected $allowed_core_constants = array(
        'ADMIN_COOKIE_PATH' => \true,
        'AUTH_COOKIE' => \true,
        'AUTOSAVE_INTERVAL' => \true,
        'COOKIEHASH' => \true,
        'COOKIEPATH' => \true,
        'COOKIE_DOMAIN' => \true,
        'EMPTY_TRASH_DAYS' => \true,
        'FORCE_SSL_ADMIN' => \true,
        'FORCE_SSL_LOGIN' => \true,
        // Deprecated.
        'LOGGED_IN_COOKIE' => \true,
        'MEDIA_TRASH' => \true,
        'MUPLUGINDIR' => \true,
        // Deprecated.
        'PASS_COOKIE' => \true,
        'PLUGINDIR' => \true,
        // Deprecated.
        'PLUGINS_COOKIE_PATH' => \true,
        'RECOVERY_MODE_COOKIE' => \true,
        'SCRIPT_DEBUG' => \true,
        'SECURE_AUTH_COOKIE' => \true,
        'SHORTINIT' => \true,
        'SITECOOKIEPATH' => \true,
        'TEST_COOKIE' => \true,
        'USER_COOKIE' => \true,
        ...
        'WP_CONTENT_DIR' => \true,
        'WP_CONTENT_URL' => \true,
        'WP_CRON_LOCK_TIMEOUT' => \true,
        'WP_DEBUG' => \true,
        'WP_DEBUG_DISPLAY' => \true,
        'WP_DEBUG_LOG' => \true,
        'WP_DEFAULT_THEME' => \true,
        'WP_DEVELOPMENT_MODE' => \true,
        'WP_MAX_MEMORY_LIMIT' => \true,
        'WP_MEMORY_LIMIT' => \true,
        'WP_PLUGIN_DIR' => \true,
        'WP_PLUGIN_URL' => \true,
        'WP_POST_REVISIONS' => \true,
        'WP_START_TIMESTAMP' => \true,
    );
    /**
    ...
    protected $pluggable_functions = array(
        ...
        'twentyfourteen_header_image' => \true,
        ...
        'twentytwentyfive_block_styles' => \true,
        'twentytwentyfive_editor_style' => \true,
        'twentytwentyfive_enqueue_styles' => \true,
        'twentytwentyfive_format_binding' => \true,
        'twentytwentyfive_pattern_categories' => \true,
        'twentytwentyfive_post_format_setup' => \true,
        'twentytwentyfive_register_block_bindings' => \true,
        'twentytwentyfour_block_styles' => \true,
        'twentytwentyfour_block_stylesheets' => \true,
        'twentytwentyfour_pattern_categories' => \true,
        ...
        'wp_cache_get_multiple_salted' => \true,
        'wp_cache_get_salted' => \true,
        'wp_cache_set_multiple' => \true,
        'wp_cache_set_multiple_salted' => \true,
        'wp_cache_set_salted' => \true,
     ...
     */
    protected $pluggable_classes = array('TwentyTwenty_Customize' => \true, 'TwentyTwenty_Non_Latin_Languages' => \true, 'TwentyTwenty_SVG_Icons' => \true, 'TwentyTwenty_Script_Loader' => \true, 'TwentyTwenty_Separator_Control' => \true, 'TwentyTwenty_Walker_Comment' => \true, 'TwentyTwenty_Walker_Page' => \true, 'Twenty_Twenty_One_Customize' => \true, 'WP_Block_Cloner' => \true, 'WP_User_Search' => \true, 'wp_atom_server' => \true);
    /**
    ...
    {
        if (preg_match('`^([A-Z]*[a-z0-9]*+)`', ltrim($construct_name, '\$_'), $matches) > 0 && '' !== $matches[1]) {
