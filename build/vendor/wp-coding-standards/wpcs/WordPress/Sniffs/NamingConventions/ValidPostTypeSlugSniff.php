...
final class ValidPostTypeSlugSniff extends AbstractFunctionParameterSniff
{
    ...
    protected $reserved_names = array(
        'action' => \true,
        // Not a WP post type, but prevents other problems.
        'attachment' => \true,
        'author' => \true,
        // Not a WP post type, but prevents other problems.
        'custom_css' => \true,
        'customize_changeset' => \true,
        'nav_menu_item' => \true,
        'oembed_cache' => \true,
        'order' => \true,
        // Not a WP post type, but prevents other problems.
        ...
        'wp_font_face' => \true,
        'wp_font_family' => \true,
        'wp_global_styles' => \true,
        'wp_navigation' => \true,
        'wp_template' => \true,
        'wp_template_part' => \true,
    );
    /**
    ...
    public function process_parameters($stackPtr, $group_name, $matched_content, $parameters)
    {
        ...
        if (\T_DOUBLE_QUOTED_STRING === $this->tokens[$string_pos]['code'] || \T_HEREDOC === $this->tokens[$string_pos]['code'] && strpos($this->tokens[$string_pos]['content'], '$') !== \false) {
