 ...
 */
namespace _PhpScoperdd275a4cd119\WordPressCS\WordPress\Sniffs\Utils;

use _PhpScoperdd275a4cd119\PHP_CodeSniffer\Util\Tokens;
use _PhpScoperdd275a4cd119\PHPCSUtils\BackCompat\Helper;
use _PhpScoperdd275a4cd119\PHPCSUtils\Utils\FilePath;
            ...
            if (\false !== $text_domain_ptr) {
                ...
                if (\true === $fix) {
                    ...
                    if (\T_DOC_COMMENT_OPEN_TAG === $this->tokens[$stackPtr]['code']) {
                        ...
                        $replacement = $this->phpcsFile->eolChar . GetTokensAsString::origContent($this->phpcsFile, $i, $last_header_ptr - 1) . $replacement;
                    }
