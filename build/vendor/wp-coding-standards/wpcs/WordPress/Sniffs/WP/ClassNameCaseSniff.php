 ...
 */
namespace _PhpScoperdd275a4cd119\WordPressCS\WordPress\Sniffs\WP;

use _PhpScoperdd275a4cd119\WordPressCS\WordPress\AbstractClassRestrictionsSniff;
/**
...
final class ClassNameCaseSniff extends AbstractClassRestrictionsSniff
{
     ...
     *               The constructor will add the lowercased class name as a key to each entry.
     */
    private $wp_themes_classes = array('TwentyNineteen_SVG_Icons', 'TwentyNineteen_Walker_Comment', 'TwentyTwenty_Customize', 'TwentyTwenty_Non_Latin_Languages', 'TwentyTwenty_SVG_Icons', 'TwentyTwenty_Script_Loader', 'TwentyTwenty_Separator_Control', 'TwentyTwenty_Walker_Comment', 'TwentyTwenty_Walker_Page', 'Twenty_Eleven_Ephemera_Widget', 'Twenty_Fourteen_Ephemera_Widget', 'Twenty_Twenty_One_Custom_Colors', 'Twenty_Twenty_One_Customize', 'Twenty_Twenty_One_Customize_Color_Control', 'Twenty_Twenty_One_Customize_Notice_Control', 'Twenty_Twenty_One_Dark_Mode', 'Twenty_Twenty_One_SVG_Icons');
    /**
     ...
     *               The constructor will add the lowercased class name as a key to each entry.
     */
    private $avif_classes = array('_PhpScoperdd275a4cd119\Avifinfo\Box', '_PhpScoperdd275a4cd119\Avifinfo\Chan_Prop', '_PhpScoperdd275a4cd119\Avifinfo\Dim_Prop', '_PhpScoperdd275a4cd119\Avifinfo\Features', '_PhpScoperdd275a4cd119\Avifinfo\Parser', '_PhpScoperdd275a4cd119\Avifinfo\Prop', '_PhpScoperdd275a4cd119\Avifinfo\Tile');
    /**
    ...
    private $phpmailer_classes = array(
        // Classes.
        '_PhpScoperdd275a4cd119\PHPMailer\PHPMailer\DSNConfigurator',
        '_PhpScoperdd275a4cd119\PHPMailer\PHPMailer\Exception',
        '_PhpScoperdd275a4cd119\PHPMailer\PHPMailer\OAuth',
        '_PhpScoperdd275a4cd119\PHPMailer\PHPMailer\PHPMailer',
        '_PhpScoperdd275a4cd119\PHPMailer\PHPMailer\POP3',
        '_PhpScoperdd275a4cd119\PHPMailer\PHPMailer\SMTP',
        // Interfaces.
        '_PhpScoperdd275a4cd119\PHPMailer\PHPMailer\OAuthTokenProvider',
    );
    /**
    ...
    private $requests_classes = array(
        ...
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Auth',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Capability',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\HookManager',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Proxy',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Transport',
        // Classes, Requests v1.
        'Requests',
        'Requests_Auth_Basic',
        'Requests_Cookie',
        ...
        // Classes, Requests v2.
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Auth\Basic',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Autoload',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Cookie',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Cookie\Jar',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\ArgumentCount',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\Http',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\Http\Status304',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\Http\Status305',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\Http\Status306',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\Http\Status400',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\Http\Status401',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\Http\Status402',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\Http\Status403',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\Http\Status404',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\Http\Status405',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\Http\Status406',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\Http\Status407',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\Http\Status408',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\Http\Status409',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\Http\Status410',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\Http\Status411',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\Http\Status412',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\Http\Status413',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\Http\Status414',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\Http\Status415',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\Http\Status416',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\Http\Status417',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\Http\Status418',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\Http\Status428',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\Http\Status429',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\Http\Status431',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\Http\Status500',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\Http\Status501',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\Http\Status502',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\Http\Status503',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\Http\Status504',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\Http\Status505',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\Http\Status511',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\Http\StatusUnknown',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\InvalidArgument',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\Transport',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Exception\Transport\Curl',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Hooks',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\IdnaEncoder',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Ipv6',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Iri',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Port',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Proxy\Http',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Requests',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Response',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Response\Headers',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Session',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Ssl',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Transport\Curl',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Transport\Fsockopen',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Utility\CaseInsensitiveDictionary',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Utility\FilteredIterator',
        '_PhpScoperdd275a4cd119\WpOrg\Requests\Utility\InputValidator',
    );
    /**
    ...
    private $simplepie_classes = array(
        ...
        '_PhpScoperdd275a4cd119\SimplePie\Cache\Base',
        '_PhpScoperdd275a4cd119\SimplePie\Cache\DataCache',
        '_PhpScoperdd275a4cd119\SimplePie\Cache\NameFilter',
        '_PhpScoperdd275a4cd119\SimplePie\HTTP\Client',
        '_PhpScoperdd275a4cd119\SimplePie\HTTP\Response',
        '_PhpScoperdd275a4cd119\SimplePie\RegistryAware',
        ...
        '_PhpScoperdd275a4cd119\SimplePie\Author',
        '_PhpScoperdd275a4cd119\SimplePie\Cache',
        '_PhpScoperdd275a4cd119\SimplePie\Cache\BaseDataCache',
        '_PhpScoperdd275a4cd119\SimplePie\Cache\CallableNameFilter',
        '_PhpScoperdd275a4cd119\SimplePie\Cache\DB',
        '_PhpScoperdd275a4cd119\SimplePie\Cache\File',
        '_PhpScoperdd275a4cd119\SimplePie\Cache\Memcache',
        '_PhpScoperdd275a4cd119\SimplePie\Cache\Memcached',
        '_PhpScoperdd275a4cd119\SimplePie\Cache\MySQL',
        '_PhpScoperdd275a4cd119\SimplePie\Cache\Psr16',
        '_PhpScoperdd275a4cd119\SimplePie\Cache\Redis',
        '_PhpScoperdd275a4cd119\SimplePie\Caption',
        '_PhpScoperdd275a4cd119\SimplePie\Category',
        '_PhpScoperdd275a4cd119\SimplePie\Content\Type\Sniffer',
        '_PhpScoperdd275a4cd119\SimplePie\Copyright',
        '_PhpScoperdd275a4cd119\SimplePie\Credit',
        '_PhpScoperdd275a4cd119\SimplePie\Enclosure',
        '_PhpScoperdd275a4cd119\SimplePie\Exception',
        '_PhpScoperdd275a4cd119\SimplePie\File',
        '_PhpScoperdd275a4cd119\SimplePie\Gzdecode',
        '_PhpScoperdd275a4cd119\SimplePie\HTTP\ClientException',
        '_PhpScoperdd275a4cd119\SimplePie\HTTP\FileClient',
        '_PhpScoperdd275a4cd119\SimplePie\HTTP\Parser',
        '_PhpScoperdd275a4cd119\SimplePie\HTTP\Psr7Response',
        '_PhpScoperdd275a4cd119\SimplePie\HTTP\Psr18Client',
        '_PhpScoperdd275a4cd119\SimplePie\HTTP\RawTextResponse',
        '_PhpScoperdd275a4cd119\SimplePie\IRI',
        '_PhpScoperdd275a4cd119\SimplePie\Item',
        '_PhpScoperdd275a4cd119\SimplePie\Locator',
        '_PhpScoperdd275a4cd119\SimplePie\Misc',
        '_PhpScoperdd275a4cd119\SimplePie\Net\IPv6',
        '_PhpScoperdd275a4cd119\SimplePie\Parse\Date',
        '_PhpScoperdd275a4cd119\SimplePie\Parser',
        '_PhpScoperdd275a4cd119\SimplePie\Rating',
        '_PhpScoperdd275a4cd119\SimplePie\Registry',
        '_PhpScoperdd275a4cd119\SimplePie\Restriction',
        '_PhpScoperdd275a4cd119\SimplePie\Sanitize',
        '_PhpScoperdd275a4cd119\SimplePie\SimplePie',
        '_PhpScoperdd275a4cd119\SimplePie\Source',
        '_PhpScoperdd275a4cd119\SimplePie\XML\Declaration\Parser',
    );
    /**
     ...
     * @var array
     */
    private $class_groups = array('wp_classes', 'wp_themes_classes', 'avif_classes', 'getid3_classes', 'phpmailer_classes', 'requests_classes', 'simplepie_classes');
    /**
     * Constructor.
     *
     * @since 3.0.0
