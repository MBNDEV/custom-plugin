...
final class DeprecatedClassesSniff extends AbstractClassRestrictionsSniff
{
    ...
    private $deprecated_classes = array(
        ...
        // WP 3.7.0.
        'WP_HTTP_Fsockopen' => array('alt' => 'WP_HTTP::request()', 'version' => '3.7.0'),
        // WP 4.9.0.
        'WP_Customize_New_Menu_Section' => array('version' => '4.9.0'),
        'WP_Customize_New_Menu_Control' => array('version' => '4.9.0'),
        // WP 5.3.0.
        'WP_Privacy_Data_Export_Requests_Table' => array('alt' => 'WP_Privacy_Data_Export_Requests_List_Table', 'version' => '5.3.0'),
        'WP_Privacy_Data_Removal_Requests_Table' => array('alt' => 'WP_Privacy_Data_Removal_Requests_List_Table', 'version' => '5.3.0'),
        'Services_JSON' => array('alt' => 'The PHP native JSON extension', 'version' => '5.3.0'),
        'Services_JSON_Error' => array('alt' => 'The PHP native JSON extension', 'version' => '5.3.0'),
        // WP 6.4.0.
        'WP_Http_Curl' => array('alt' => 'WP_Http', 'version' => '6.4.0'),
        'WP_Http_Streams' => array('alt' => 'WP_Http', 'version' => '6.4.0'),
    );
    /**
