...
use _PhpScoperdd275a4cd119\YahnisElsts\PluginUpdateChecker\v5p6\UpdateChecker;
if (!class_exists(Panel::class, \false) && class_exists('_PhpScoperdd275a4cd119\Debug_Bar_Panel', \false)) {
    class Panel extends \_PhpScoperdd275a4cd119\Debug_Bar_Panel
    {
        /** @var UpdateChecker */
        ...
        private function displayStatus()
        {
            ...
            if (function_exists('_PhpScoperdd275a4cd119\get_submit_button')) {
