...
use _PhpScoperdd275a4cd119\YahnisElsts\PluginUpdateChecker\v5p6\Vcs;
if (!class_exists(PucFactory::class, \false)) {
    ...
    class PucFactory
    {
        ...
        {
            if (function_exists('_PhpScoperdd275a4cd119\wp_normalize_path')) {
        ...
        protected static function isPluginFile($absolutePath)
        {
            ...
            if (function_exists('_PhpScoperdd275a4cd119\get_file_data')) {
