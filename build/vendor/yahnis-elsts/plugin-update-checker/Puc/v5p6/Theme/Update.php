...
use _PhpScoperdd275a4cd119\YahnisElsts\PluginUpdateChecker\v5p6\Update as BaseUpdate;
        ...
        protected function validateMetadata($apiResponse)
        {
            ...
            foreach ($required as $key) {
                if (!isset($apiResponse->{$key}) || empty($apiResponse->{$key})) {
                    return new \_PhpScoperdd275a4cd119\WP_Error('tuc-invalid-metadata', sprintf('The theme metadata is missing the required "%s" key.', $key));
                }
            }
            return \true;
        }
