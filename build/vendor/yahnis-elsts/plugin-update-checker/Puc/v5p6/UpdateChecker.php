...
use stdClass;
use _PhpScoperdd275a4cd119\WP_Error;
if (!class_exists(UpdateChecker::class, \false)) {
    abstract class UpdateChecker
    {
        ...
        public function loadTextDomain()
        {
            ...
            $locale = apply_filters('plugin_locale', is_admin() && function_exists('_PhpScoperdd275a4cd119\get_user_locale') ? get_user_locale() : get_locale(), $domain);
        ...
        protected function fixSupportedWordpressVersion($update = null)
        {
            ...
            if (function_exists('_PhpScoperdd275a4cd119\get_core_updates')) {
        ...
        {
            if (!function_exists('_PhpScoperdd275a4cd119\wp_get_installed_translations')) {
                return array();
            }
        ...
        {
            if (class_exists('_PhpScoperdd275a4cd119\Debug_Bar', \false) && class_exists('_PhpScoperdd275a4cd119\Debug_Bar_Panel', \false) && file_exists(dirname(__FILE__) . '/DebugBar')) {
