...
if (!class_exists(UpgraderStatus::class, \false)) {
    ...
    class UpgraderStatus
    {
        ...
        private function getThingBeingUpgradedBy($upgrader)
        {
            ...
            $skin = $upgrader->skin;
            if (isset($skin->theme_info) && $skin->theme_info instanceof \_PhpScoperdd275a4cd119\WP_Theme) {
                $themeDirectoryName = $skin->theme_info->get_stylesheet();
            } elseif ($skin instanceof \_PhpScoperdd275a4cd119\Plugin_Upgrader_Skin) {
                if (isset($skin->plugin) && is_string($skin->plugin) && $skin->plugin !== '') {
                    $pluginFile = $skin->plugin;
                }
            } elseif ($skin instanceof \_PhpScoperdd275a4cd119\Theme_Upgrader_Skin) {
        ...
        {
            if (!function_exists('_PhpScoperdd275a4cd119\get_plugins')) {
