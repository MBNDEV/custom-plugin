...
use _PhpScoperdd275a4cd119\Parsedown;
if (!class_exists(GitHubApi::class, \false)) {
    class GitHubApi extends Api
    {
        ...
        protected function api($url, $queryParams = array())
        {
            ...
            $error = new \_PhpScoperdd275a4cd119\WP_Error('puc-github-http-error', sprintf('GitHub API error. Base URL: "%s",  HTTP status code: %d.', $baseUrl, $code));
