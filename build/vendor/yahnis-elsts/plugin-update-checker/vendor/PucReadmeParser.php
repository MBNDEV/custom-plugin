...
if (!\class_exists('_PhpScoperdd275a4cd119\PucReadmeParser', \false)) {
    /**
    ...
    class PucReadmeParser
    {
        ...
        {
            // whitelisted chars
            if (\function_exists('_PhpScoperdd275a4cd119\user_sanitize')) {
                // bbPress native
        ...
        {
            // not fancy
            $text = \function_exists('_PhpScoperdd275a4cd119\wp_strip_all_tags') ? wp_strip_all_tags($text) : \strip_tags($text);
            $text = esc_html($text);
            $text = \trim($text);
            return $text;
        }
        function filter_text($text, $markdown = \false)
        {
            ...
            if ($markdown) {
                // Parse markdown.
                if (!\class_exists('_PhpScoperdd275a4cd119\Parsedown', \false)) {
        ...
        {
            if (\function_exists('_PhpScoperdd275a4cd119\encodeit')) {
                // bbPress native
        ...
        {
            if (\function_exists('_PhpScoperdd275a4cd119\decodeit')) {
                // bbPress native
     ...
     * It uses Parsedown instead of the "Markdown Extra" parser.
     */
    \class_alias('_PhpScoperdd275a4cd119\PucReadmeParser', 'PucReadmeParser', \false);
    // end class
}
